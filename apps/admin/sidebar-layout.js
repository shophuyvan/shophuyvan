    ...
    <aside class="admin-sidebar" id="adminSidebar">
      ...
      <nav class="admin-sidebar-menu">
        <div class="admin-menu-section">
          ...
          <a href="/flash-sales.html" class="admin-menu-item" data-page="flash-sales">
            <svg class="admin-menu-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <a href="/douyin/douyin-localization.html" class="admin-menu-item" data-page="douyin-localization">
            <svg class="admin-menu-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
            Douyin Global AI
            <span style="background: #2563eb; color: white; font-size: 9px; padding: 2px 4px; border-radius: 4px; margin-left: auto;">BETA</span>
          </a>

          <a href="/douyin/douyin-upload.html" class="admin-menu-item" data-page="douyin-upload">
            <svg class="admin-menu-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <a href="/channels.html" class="admin-menu-item" data-page="channels">
            <svg class="admin-menu-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5h4l2 4h9a1 1 0 01.9.55l2 4A1 1 0 0120 15H9a1 1 0 01-.9-.55L6 11H3a1 1 0 01-1-1V6a1 1 0 011-1zM5 19a2 2 0 114 0 2 2 0 01-4 0zm10 0a2 2 0 114 0 2 2 0 01-4 0z"/>
            </svg>
            Kênh TMDT
          </a>

          <a href="/sku-mapping.html" class="admin-menu-item" data-page="sku-mapping">
            <svg class="admin-menu-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  window.AdminLayout = {
    ...
    filterMenuByPermissions(permissions) {
      ...
      const menuPermissions = {
        ...
        'stats': 'stats.view',
        'ads': 'ads.view',
        'auto-video-sync': 'ads.view',
        'douyin-localization': 'ads.view',
