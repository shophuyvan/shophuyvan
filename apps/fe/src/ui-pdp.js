...
function openCheckoutModal(){
  ...
  <div class="co-modal" style="max-height:92vh;overflow:auto;background:#fff;border-radius:12px;padding:14px 14px 80px 14px;position:relative">
    ...
    <div id="co-form" style="display:grid;grid-template-columns:1fr;gap:10px">
      ...
      <style id="co-grid-style">.co-grid{display:grid;grid-template-columns:1fr;gap:10px;width:100%}@media(min-width:640px){.co-grid{grid-template-columns:1fr 1fr;gap:12px}}.co-grid select,.co-grid input{width:100%;max-width:100%;box-sizing:border-box;display:block;min-height:44px}</style><div class="co-grid" style="grid-column:1 / -1;width:100%;">
        <select id="co-province-sel" style="width:100%;box-sizing:border-box;border:1px solid #e5e7eb;border-radius:8px;padding:12px;display:block;grid-column:1 / -1;min-height:44px;width:100%;max-width:100%;display:block">
