...
// .wrangler/tmp/bundle-jaFScK/checked-fetch.js
...
// ../../.wrangler/tmp/pages-ruUIkm/functionsWorker-0.08858059636802618.mjs
...
async function onRequest(context) {
  ...
  const escapeCsv = /* @__PURE__ */ __name2((val = "") => {
    const s = String(val ?? "");
    const needsQuote = /[",\n]/.test(s);
    const out = s.replace(/"/g, '""');
    return needsQuote ? `"${out}"` : out;
  }, "escapeCsv");
  const priceVND = /* @__PURE__ */ __name2((n) => `${Math.round(Number(n || 0))} VND`, "priceVND");
  let products = [];
  try {
...
// .wrangler/tmp/bundle-jaFScK/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-jaFScK/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.08858059636802618.js.map
