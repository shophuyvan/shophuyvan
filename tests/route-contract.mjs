...
assert.match(adminWorker, /ADMIN_UI_REVISION/);
...
assert.match(adminRender, /ca-brand-lockup/);
assert.match(adminRender, /ca-dashboard-grid/);
...
assert.match(adminDashboardCss, /--ca-sidebar-w: 240px/);
assert.match(adminDashboardCss, /\.ca-topbar-search/);
assert.match(adminDashboardCss, /grid-template-columns: repeat\(4, minmax\(0, 1fr\)\)/);
