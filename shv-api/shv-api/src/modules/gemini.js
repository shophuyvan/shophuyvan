...
// shv-api/src/modules/gemini.js (v6.3) — real call
...
export async function handleAI(req, env) {
  ...
  if(!apiKey){
    if (mode==="title") return new Response(JSON.stringify(fallbackTitle()), { headers:{ "content-type":"application/json" } });
