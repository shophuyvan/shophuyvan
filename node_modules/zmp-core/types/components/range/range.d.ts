...
export namespace Range {
  ...
  interface Range extends ZMPEventsClass<Events> {
    /** Link to global app instance */
    app: ZMP;
    /** Range HTML element */
    el: HTMLElement;
    /** zmpDOM instance with range HTML element */
    $el: zmpDOMArray;
    /** Range Slider input HTML element */
    inputEl: HTMLElement;
    /** zmpDOM instance with range slider input HTML element */
    $inputEl: zmpDOMArray;
...
declare const RangeComponent: ZMPPlugin;
