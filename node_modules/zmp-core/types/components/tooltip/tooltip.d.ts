...
export namespace Tooltip {
  ...
  interface Tooltip extends ZMPEventsClass<Events> {
    /** Link to global app instance */
    app: ZMP;
    /** Tooltip HTML element */
    el: HTMLElement;
    /** zmpDOM instance with tooltip HTML element */
    $el: zmpDOMArray;
    /** Tooltip parameters */
    params: Parameters;
    /** Tooltip target HTML element */
    targetEl: HTMLElement;
    /** zmpDOM instance with tooltip target HTML element */
...
declare const TooltipComponent: ZMPPlugin;
