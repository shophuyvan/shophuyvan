...
export namespace Popover {
  ...
  interface Popover extends ZMPEventsClass<Events> {
    /** Link to global app instance */
    app: ZMP;
    /** Popover HTML element */
    el: HTMLElement;
    /** zmpDOM instance with popover HTML element */
    $el: zmpDOMArray;
    ...
    /** zmpDOM instance with popover target HTML element */
...
declare const PopoverComponent: ZMPPlugin;
