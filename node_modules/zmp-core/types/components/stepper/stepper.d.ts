...
export namespace Stepper {
  ...
  interface Stepper extends ZMPEventsClass<Events> {
    /** Link to global app instance */
    app: ZMP;
    /** Stepper HTML element */
    el: HTMLElement;
    /** zmpDOM instance with stepper HTML element */
    $el: zmpDOMArray;
    /** Stepper min value */
    min: number;
    /** Stepper max value */
    ...
    inputEl: HTMLElement;
    /** zmpDOM instance with stepper input HTML element */
    $inputEl: zmpDOMArray;
    /** Stepper value container HTML element */
    valueEl: HTMLElement;
    /** zmpDOM instance with stepper value container HTML element */
    $valueEl: HTMLElement;
    /** Stepper parameters */
    params: Parameters;
...
declare const StepperComponent: ZMPPlugin;
