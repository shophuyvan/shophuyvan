...
export namespace Autocomplete {
  interface Autocomplete extends ZMPEventsClass<Events> {
    ...
    /** zmpDOM instance of of Autocomplete opener element (if passed on init) */
    $openerEl: zmpDOMArray | undefined;
    /** HTML element of Autocomplete input (if passed on init) */
    inputEl: HTMLElement | undefined;
    /** zmpDOM instance of of Autocomplete input (if passed on init) */
    $inputEl: zmpDOMArray | undefined;
    /** zmpDOM instance of Autocomplete dropdown */
    $dropdownEl: zmpDOMArray | undefined;
    ...
    /** zmpDOM instance of Autocomplete container: dropdown element, or popup element, or page element. Available when Autocomplete opened */
    $el: zmpDOMArray | undefined;
...
declare const AutocompleteComponent: ZMPPlugin;
