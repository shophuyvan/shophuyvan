...
export namespace Toggle {
  ...
  interface Toggle extends ZMPEventsClass<Events> {
    /** Link to global app instance */
    app: ZMP;
    /** Toggle HTML element */
    el: HTMLElement;
    /** zmpDOM instance with toggle HTML element */
    $el: zmpDOMArray;
    /** Toggle input HTML element */
    inputEl: HTMLElement;
    /** zmpDOM instance with toggle input HTML element */
    $inputEl: zmpDOMArray;
...
declare const ToggleComponent: ZMPPlugin;
