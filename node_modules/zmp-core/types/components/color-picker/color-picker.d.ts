...
export namespace ColorPicker {
  ...
  interface ColorPicker extends ZMPEventsClass<Events> {
    /** Link to global app instance */
    app: ZMP;
    /** Color Picker wrapping container HTML element (when inline Color Picker is in use) */
    containerEl: HTMLElement;
    /** zmpDOM instance with Color Picker wrapping container HTML element (when inline Color Picker is in use) */
    $containerEl: zmpDOMArray;
    /** Color Picker HTML element */
    el: HTMLElement;
    /** zmpDOM instance with Color Picker HTML element */
    $el: zmpDOMArray;
    /** Color Picker input HTML element (passed in inputEl parameter) */
    inputEl: HTMLElement;
    /** zmpDOM instance with Color Picker input HTML element (passed in inputEl parameter) */
    $inputEl: zmpDOMArray;
    /** Color Picker target HTML element (passed in targetEl parameter) */
    targetEl: HTMLElement;
    /** zmpDOM instance with Color Picker target HTML element (passed in targetEl parameter) */
    $targetEl: zmpDOMArray;
    /** Object with value */
...
declare const ColorPickerComponent: ZMPPlugin;
