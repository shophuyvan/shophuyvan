...
export namespace Dialog {
  interface Dialog extends ZMPEventsClass<Events> {
    /** Link to global app instance */
    app: ZMP;
    /** Dialog HTML element */
    el: HTMLElement;
    /** zmpDOM instance with dialog HTML element */
    $el: zmpDOMArray; // zmpDOMArray
    /** Backdrop HTML element */
    backdropEl: HTMLElement;
    /** zmpDOM instance with backdrop HTML element */
    $backdropEl: zmpDOMArray; // zmpDOMArray
    /** Dialog parameters */
    params: Parameters;
...
declare const DialogComponent: ZMPPlugin;
