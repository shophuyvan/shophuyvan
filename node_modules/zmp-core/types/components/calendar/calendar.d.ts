...
export namespace Calendar {
  interface Calendar extends ZMPEventsClass<Events> {
    /** Link to global app instance */
    app: ZMP;
    /** Calendar wrapping container HTML element (when inline calendar is in use) */
    containerEl: HTMLElement;
    /** zmpDOM instance with calendar wrapping container HTML element (when inline calendar is in use) */
    $containerEl: zmpDOMArray;
    /** Calendar HTML element */
    el: HTMLElement;
    /** zmpDOM instance with calendar HTML element */
    $el: zmpDOMArray;
    /** Calendar input HTML element (passed in inputEl parameter) */
    inputEl: HTMLElement;
    /** zmpDOM instance with calendar input HTML element (passed in inputEl parameter) */
    $inputEl: zmpDOMArray;
...
declare const CalendarComponent: ZMPPlugin;
