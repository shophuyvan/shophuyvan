...
export namespace Panel {
  ...
  interface Panel extends ZMPEventsClass<Events> {
    ...
    /** Panel HTML element */
    el: HTMLElement;
    /** zmpDOM instance with panel HTML element */
    $el: zmpDOMArray;
    /** Backdrop HTML element */
    backdropEl: HTMLElement;
    /** zmpDOM instance with backdrop HTML element */
    $backdropEl: zmpDOMArray;
    /** Popup parameters */
    params: Parameters;
    /** Element to mount panel to. (default app.el) */
    containerEl: HTMLElement | CSSSelector;
    /** zmpDOM instance with element to mount panel to. (default app.el) */
...
declare const PanelComponent: ZMPPlugin;
