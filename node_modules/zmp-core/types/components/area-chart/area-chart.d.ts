...
export namespace AreaChart {
  interface AreaChart extends ZMPEventsClass<Events> {
    /** Link to global app instance */
    app: ZMP;
    /** Area chart HTML element */
    el: HTMLElement;
    /** zmpDOM instance with chart HTML element */
    $el: zmpDOMArray;
    /** Area chart generated SVH HTML element */
    svgEl: HTMLElement;
    /** zmpDOM instance with generated SVH HTML element */
    $svgEl: zmpDOMArray;
...
declare const AreaChartComponent: ZMPPlugin;
