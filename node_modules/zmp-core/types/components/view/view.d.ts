...
export namespace View {
  interface View extends ZMPEventsClass<Events> {
    /** Link to global app instance */
    app: ZMP;
    /** View HTML element */
    el: HTMLElement;
    /** zmpDOM instance with view HTML element */
    $el: zmpDOMArray;
  ...
  interface Parameters {
    ...
    /**	Set to true when your server cofigured to respond with content that matches to requested URL (e.g. using with server-side rendering frameworks like Nuxt.js, Next.js, and others). Also must be enabled when used in ZMP-React/Vue/Svelte. By default disabled */
...
declare const ViewComponent: ZMPPlugin;
