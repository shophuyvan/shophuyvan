...
export namespace SmartSelect {
  ...
  interface Parameters {
    ...
    /** Select option icon to be set on all options. If it just a string then will create an icon with this class. If it is in the format of `zmp:icon_name` then it will create a zmp-icons icon. If it is in the format of `md:icon_name` then it will create a Material Icons icon. */
    optionIcon?: string;
  ...
  interface SmartSelect extends ZMPEventsClass<Events> {
    /** Link to global app instance */
    app: ZMP;
    /** Smart Select HTML element */
    el: HTMLElement;
    /** zmpDOM instance with Smart Select HTML element */
    $el: zmpDOMArray;
    /** HTML element used to display value */
    valueEl: HTMLElement;
    /** zmpDOM instance with HTML element used to display value */
    $valueEl: zmpDOMArray;
    /** Child select element <select> */
    selectEl: HTMLElement;
    /** zmpDOM instance with child select element */
    $selectEl: zmpDOMArray;
...
declare const SmartSelectComponent: ZMPPlugin;
