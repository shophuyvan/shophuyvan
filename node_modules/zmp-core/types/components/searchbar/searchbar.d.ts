...
export namespace Searchbar {
  ...
  interface Searchbar extends ZMPEventsClass<Events> {
    /** Searchbar HTML element */
    el: HTMLElement;
    /** zmpDOM instance with searchbar HTML element */
    $el: zmpDOMArray;
    /** Searchbar input HTML element */
    inputEl: HTMLElement;
    /** zmpDOM instance with searchbar input HTML element */
    $inputEl: zmpDOMArray;
    ...
    /** zmpDOM element with searchbar search container */
    $searchContainer: zmpDOMArray;
...
declare const SearchbarComponent: ZMPPlugin;
