import ZMP, { ZMPEventsClass, ZMPPlugin, CSSSelector } from '../../components/app/app-class';
...
export namespace Router {
  interface ModalRouteParameters {
    ...
    content?: string | HTMLElement | zmpDOMArray | HTMLElement[];
    /** Load page content via Ajax. */
    url?: string;
    /** Load page from passed ZMP Router Component */
  ...
  interface RouteParameters {
    ...
    master?: boolean | ((zmp: ZMP, router: Router) => boolean);
  ...
  interface Page {
    ...
    /** Page element */
    el: HTMLElement;
    /** zmpDOM instance with Page element */
    $el: zmpDOMArray;
    /** Related navbar element for this page. Available only in iOS theme with dynamic navbar enabled. */
    navbarEl: HTMLElement;
    /** zmpDOM instance with related navbar element for this page. Available only in iOS theme with dynamic navbar enabled. */
    $navbarEl: zmpDOMArray;
  ...
  interface Router extends ZMPEventsClass<Events> {
    ...
    el: HTMLElement;
    /** zmpDOM instance with router's view HTML element */
    $el: zmpDOMArray;
  ...
  interface DomEvents {
    ...
    'page:mounted': () => void;
    /** Event will be triggered after ZMP initialize required page's components and navbar */
    'page:init': () => void;
...
declare const RouterModule: ZMPPlugin;
