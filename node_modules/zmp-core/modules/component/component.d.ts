...
export interface ComponentContext {
  ...
  $zmproute: Router.Route;
  /** Router instance */
  $zmprouter: Router.Router;
  /** ZMP app instance */
  $zmp: ZMP;
  ...
  /** Main app store */
  $store: Store;
  /** Object where `value` contains zmpDOM instance with component HTML element */
  $el: {
    value: zmpDOMArray;
  };
...
export class ComponentClass {
  constructor(app: ZMP, component: ComponentFunction, props?: object, context?: object);
}
...
declare const ComponentModule: ZMPPlugin;
