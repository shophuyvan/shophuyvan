...
.view-master-detail .navbar-master {
  ...
  --zmp-safe-area-right: 0px;
  --zmp-safe-area-outer-right: 0px;
  border-right: var(--zmp-page-master-border-width) solid var(--zmp-page-master-border-color);
}
...
.ios .navbar .right:first-child {
  right: calc(8px + var(--zmp-safe-area-right));
}
.ios .navbar-inner {
...
.subnavbar .subnavbar-title {
  ...
  margin-left: var(--zmp-subnavbar-title-margin-left);
}
.subnavbar .left,
.subnavbar .right {
  flex-shrink: 0;
...
.ios .toast-button {
  margin-left: 16px;
  margin-right: calc(-1 * var(--zmp-button-padding-horizontal));
}
.md .toast {
  transition-duration: 200ms;
  border-radius: var(--zmp-toast-border-radius);
...
.list ul ul {
  padding-left: calc(var(--zmp-list-item-padding-horizontal) + var(--zmp-list-in-list-padding-left));
}
.list ul ul:before,
.list ul ul:after {
  display: none !important;
...
.list .item-media + .item-inner {
  margin-left: var(--zmp-list-item-media-margin);
}
.list .item-media i + i,
.list .item-media i + img {
  margin-left: var(--zmp-list-item-media-icons-margin);
}
.list .item-after {
  padding-left: var(--zmp-list-item-after-padding);
}
.list .item-inner {
  position: relative;
  width: 100%;
...
.list .item-link .item-inner {
  padding-right: calc(var(--zmp-list-chevron-icon-area) + var(--zmp-list-item-padding-horizontal) + var(--zmp-safe-area-right) - var(--menu-list-offset));
}
.list .item-content {
  display: flex;
  justify-content: space-between;
...
.list .item-cell {
  ...
  width: 100%;
  min-width: 0;
  margin-left: var(--zmp-list-item-cell-margin);
  flex-shrink: 1;
}
...
.links-list a {
  padding-left: calc(var(--zmp-list-item-padding-horizontal) + var(--zmp-safe-area-left));
  padding-right: calc(var(--zmp-list-chevron-icon-area) + var(--zmp-list-item-padding-horizontal) + var(--zmp-safe-area-right));
}
.links-list a:after {
  left: calc(var(--zmp-list-item-padding-horizontal) + var(--zmp-safe-area-left));
  right: 0;
...
li.media-item .item-link .item-title-row {
  padding-right: calc(var(--zmp-list-chevron-icon-area));
}
...
li.media-item .item-link.chevron-center .item-inner:before {
  ...
  content: var(--zmp-list-chevron-icon-right);
}
...
.accordion-opposite.links-list .accordion-item > a:before {
  ...
  left: calc((var(--zmp-list-chevron-icon-area) + var(--zmp-list-item-padding-horizontal)) / 2 + var(--zmp-safe-area-left));
}
...
.timeline-month-title span {
  ...
  position: -webkit-sticky;
  position: sticky;
  left: calc(var(--zmp-timeline-horizontal-item-padding) + var(--zmp-safe-area-left));
}
.timeline-month-title span {
  margin-top: -2px;
}
...
.md .chip-delete {
  margin-right: calc(-1 * var(--zmp-chip-padding-horizontal) + 4px);
}
...
.checkbox i:after {
  ...
  position: relative;
  transition-property: opacity;
  left: calc(0px - var(--zmp-checkbox-border-width));
}
...
label.item-checkbox > .icon-checkbox {
  margin-right: calc(var(--zmp-list-item-media-margin) + var(--zmp-checkbox-extra-margin));
}
...
.ios label.item-radio:not(.item-radio-icon-start) input[type='radio'] ~ .icon-radio {
  ...
  top: 50%;
  margin-top: -11px;
  right: calc(var(--zmp-safe-area-right) + 10px);
}
.ios label.item-radio:not(.item-radio-icon-start) .item-inner {
  padding-right: calc(var(--zmp-safe-area-right) + 36px);
}
...
.md label.item-radio:not(.item-radio-icon-end) > .icon-radio {
  margin-right: calc(var(--zmp-list-item-media-margin) + var(--zmp-radio-extra-margin));
}
.md label.item-radio-icon-end input[type='radio'] ~ .icon-radio {
  position: absolute;
  top: 50%;
  margin-top: -10px;
  right: calc(var(--zmp-safe-area-right) + 16px);
}
.md label.item-radio-icon-end .item-inner {
  padding-right: calc(var(--zmp-safe-area-right) + 52px);
}
.aurora .icon-radio {
  transition-duration: 150ms;
  overflow: hidden;
...
.aurora label.item-radio-icon-end .item-inner {
  padding-right: calc(var(--zmp-safe-area-right) + 48px);
}
...
.ios .toggle-active-state input[type='checkbox']:checked + .toggle-icon:after {
  transform: translateX(calc(var(--zmp-toggle-width) - var(--zmp-toggle-height) - 8px));
}
...
.md .toggle input[type='checkbox']:checked + .toggle-icon:after {
  transform: translateX(calc(var(--zmp-toggle-width) - var(--zmp-toggle-height) - 6px));
  background: var(--zmp-toggle-active-color, var(--zmp-theme-color));
}
.md .toggle-icon {
  background: var(--zmp-toggle-inactive-color);
...
.range-slider-horizontal .range-scale-step {
  ...
  top: 0;
  margin-left: calc(-1 * var(--zmp-range-scale-step-width) / 2);
}
...
.range-slider-horizontal .range-scale-step:last-child {
  margin-left: calc(-1 * var(--zmp-range-scale-step-width));
}
...
.md .ptr-preloader {
  ...
  left: 50%;
  margin-left: calc(-1 * var(--zmp-ptr-size) / 2);
}
...
.searchbar input[type='search'] {
  ...
  position: relative;
  padding: 0;
  padding-left: calc(var(--zmp-searchbar-input-padding-horizontal) + var(--zmp-searchbar-input-extra-padding-left, 0px));
  padding-right: calc(var(--zmp-searchbar-input-padding-horizontal) + var(--zmp-searchbar-input-extra-padding-right, 0px));
}
...
.searchbar.searchbar-inline input[type='search'] {
  ...
  padding-left: calc(var(--zmp-searchbar-inline-input-padding-horizontal, var(--zmp-searchbar-input-padding-horizontal)) + var(--zmp-searchbar-input-extra-padding-left, 0px));
  padding-right: calc(var(--zmp-searchbar-inline-input-padding-horizontal, var(--zmp-searchbar-input-padding-horizontal)) + var(--zmp-searchbar-input-extra-padding-right, 0px));
}
...
.menu-item {
  ...
  cursor: pointer;
  margin-left: var(--zmp-menu-item-spacing);
}
...
.treeview-item-root {
  padding-left: var(--zmp-treeview-item-padding-left);
  padding-right: var(--zmp-treeview-item-padding-right);
...
.treeview-item-content:first-child {
  margin-left: calc(var(--zmp-treeview-toggle-size) + 5px);
}
.treeview-item-content > * + * {
  margin-left: 5px;
}
...
.treeview-toggle:after {
  ...
  transform: translate(-50%, -50%);
  border-left: 6px solid var(--zmp-treeview-toggle-color);
}
...
.treeview-preloader {
  ...
  margin-right: calc(-1 * var(--zmp-treeview-toggle-size));
}
...
.treeview-item .treeview-item .treeview-item-root {
  padding-left: calc(var(--zmp-treeview-item-padding-left) + var(--zmp-treeview-children-offset) * 1);
}
.treeview-item .treeview-item .treeview-item .treeview-item-root {
  padding-left: calc(var(--zmp-treeview-item-padding-left) + var(--zmp-treeview-children-offset) * 2);
}
.treeview-item .treeview-item .treeview-item .treeview-item .treeview-item-root {
  padding-left: calc(var(--zmp-treeview-item-padding-left) + var(--zmp-treeview-children-offset) * 3);
}
.treeview-item .treeview-item .treeview-item .treeview-item .treeview-item .treeview-item-root {
  padding-left: calc(var(--zmp-treeview-item-padding-left) + var(--zmp-treeview-children-offset) * 4);
}
.treeview-item .treeview-item .treeview-item .treeview-item .treeview-item .treeview-item .treeview-item-root {
  padding-left: calc(var(--zmp-treeview-item-padding-left) + var(--zmp-treeview-children-offset) * 5);
}
.treeview-item .treeview-item .treeview-item .treeview-item .treeview-item .treeview-item .treeview-item .treeview-item-root {
  padding-left: calc(var(--zmp-treeview-item-padding-left) + var(--zmp-treeview-children-offset) * 6);
}
.treeview-item .treeview-item .treeview-item .treeview-item .treeview-item .treeview-item .treeview-item .treeview-item .treeview-item-root {
  padding-left: calc(var(--zmp-treeview-item-padding-left) + var(--zmp-treeview-children-offset) * 7);
}
.treeview-item .treeview-item .treeview-item .treeview-item .treeview-item .treeview-item .treeview-item .treeview-item .treeview-item .treeview-item-root {
  padding-left: calc(var(--zmp-treeview-item-padding-left) + var(--zmp-treeview-children-offset) * 8);
}
.treeview-item .treeview-item .treeview-item .treeview-item .treeview-item .treeview-item .treeview-item .treeview-item .treeview-item .treeview-item .treeview-item-root {
  padding-left: calc(var(--zmp-treeview-item-padding-left) + var(--zmp-treeview-children-offset) * 9);
}
.treeview-item .treeview-item .treeview-item .treeview-item .treeview-item .treeview-item .treeview-item .treeview-item .treeview-item .treeview-item .treeview-item .treeview-item-root {
  padding-left: calc(var(--zmp-treeview-item-padding-left) + var(--zmp-treeview-children-offset) * 10);
}
