...
export namespace VirtualList {
  ...
  interface VirtualList extends ZMPEventsClass<Events> {
    items: any[];
    filteredItems: any[];
    domCache: object;
    /** Virtual list target list block element */
    el: HTMLElement;
    /** zmpDOM instance of target list block element */
    $el: zmpDOMArray;
    /** Parameters passed on list initialization */
    params: Parameters;
    /** Parent "page-content" element */
    pageContentEl: HTMLElement;
    /** zmpDOM instance of parent "page-content" element */
    $pageContentEl: zmpDOMArray;
...
declare const VirtualListComponent: ZMPPlugin;
