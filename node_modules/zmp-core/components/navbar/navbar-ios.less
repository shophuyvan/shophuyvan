.ios {
  ...
  .router-transition-forward {
    ...
    .navbar-current.router-navbar-transition-from-large:not(.router-navbar-transition-to-large) {
      .title-large {
        overflow: visible;
        .title-large-text {
          animation: ios-navbar-large-title-text-slide-up var(--zmp-page-transition-duration)
              forwards,
            ios-navbar-large-title-text-fade-out var(--zmp-page-transition-duration) forwards;
        }
      }
    }
    ...
    .navbar-next.router-navbar-transition-from-large.router-navbar-transition-to-large {
      .title-large {
        overflow: visible;
        .title-large-text {
          animation: ios-navbar-large-title-text-slide-left var(--zmp-page-transition-duration)
            forwards;
        }
      }
    }
  ...
  .router-transition-backward {
    .navbar-current.router-navbar-transition-to-large .left .back span {
      animation: ios-navbar-back-text-current-to-previous var(--zmp-page-transition-duration)
        forwards;
      transition: none;
      .ltr({
        transform-origin: left center;
    ...
    .navbar-current.router-navbar-transition-from-large.router-navbar-transition-to-large {
      .title-large {
        overflow: visible;
        .title-large-text {
          animation: ios-navbar-large-title-text-slide-right var(--zmp-page-transition-duration)
            forwards;
        }
      }
    }
    ...
    .navbar-previous.router-navbar-transition-to-large:not(.router-navbar-transition-from-large) {
      .title-large {
        ...
        opacity: 1;
        .title-large-text {
          animation: ios-navbar-large-title-text-slide-down var(--zmp-page-transition-duration)
              forwards,
            ios-navbar-large-title-text-fade-in var(--zmp-page-transition-duration) forwards;
        }
      }
    }
  ...
  --zmp-navbar-large-bg-center-top: translateX(0)
    translateY(calc(-1 * var(--zmp-navbar-large-title-height)));
