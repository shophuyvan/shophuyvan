...
export namespace Toast {
  ...
  interface Parameters {
    ...
    /** Toast icon HTML layout, e.g. <i class="zmp-icons">house</i> or image <img src="path/to/icon.png"> */
    icon?: string;
    /** Toast inner text */
    text?: string;
  ...
  interface Toast extends ZMPEventsClass<Events> {
    /** Link to global app instance */
    app: ZMP;
    /** Toast HTML element */
    el: HTMLElement;
    /** zmpDOM instance with toast HTML element */
    $el: zmpDOMArray;
    /** Toast parameters */
    params: Parameters;
...
declare const ToastComponent: ZMPPlugin;
