...
export namespace TextEditor {
  ...
  interface TextEditor extends ZMPEventsClass<Events> {
    /** Link to global app instance */
    app: ZMP;
    /** Editor HTML element */
    el: HTMLElement;
    /** zmpDOM instance with editor HTML element */
    $el: zmpDOMArray;
    /** Editor contenteditable content element */
    contentEl: HTMLElement;
    /** zmpDOM instance with editor contenteditable content element */
    $contentEl: zmpDOMArray;
...
declare const TextEditorComponent: ZMPPlugin;
