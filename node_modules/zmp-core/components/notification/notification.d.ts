...
export namespace Notification {
  interface Notification extends ZMPEventsClass<Events> {
    /** Link to global app instance */
    app: ZMP;
    /** Notification HTML element */
    el: HTMLElement;
    /** zmpDOM instance with notification HTML element */
    $el: zmpDOMArray;
  ...
  interface Parameters {
    ...
    el?: HTMLElement;
    /** Notification icon HTML layout, e.g. <i class="zmp-icons">house</i> or image <img src="path/to/icon.png">. */
    icon?: string;
    /** Notification title. */
    title?: string;
...
declare const NotificationComponent: ZMPPlugin;
