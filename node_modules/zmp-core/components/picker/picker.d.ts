...
export namespace Picker {
  interface Picker extends ZMPEventsClass<Events> {
    /** Link to global app instance */
    app: ZMP;
    /** Picker wrapping container HTML element (when inline picker is in use) */
    containerEl: HTMLElement;
    /** zmpDOM instance with picker wrapping container HTML element (when inline picker is in use) */
    $containerEl: zmpDOMArray;
    /** Picker HTML element */
    el: HTMLElement;
    /** zmpDOM instance with picker HTML element */
    $el: zmpDOMArray;
    /** Picker input HTML element (passed in inputEl parameter) */
    inputEl: HTMLElement;
    /** zmpDOM instance with picker input HTML element (passed in inputEl parameter) */
    $inputEl: zmpDOMArray;
  ...
  interface Column {
    /** Column HTML element */
    el: HTMLElement;
    /** zmpDOM instance with column HTML container */
    $el: zmpDOMArray;
    /** zmpDOM instance with column items HTML elements */
    items: HTMLElement[];
...
declare const PickerComponent: ZMPPlugin;
