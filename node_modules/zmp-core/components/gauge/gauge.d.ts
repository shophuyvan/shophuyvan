...
export namespace Gauge {
  interface Gauge extends ZMPEventsClass<Events> {
    /** Link to global app instance */
    app: ZMP;
    /** Gauge HTML element */
    el: HTMLElement;
    /** zmpDOM instance with gauge HTML element */
    $el: zmpDOMArray;
    /** Gauge generated SVH HTML element */
    svgEl: HTMLElement;
    /** zmpDOM instance with generated SVG HTML element */
    $svgEl: zmpDOMArray;
    /** Gauge parameters */
    params: Parameters;
...
declare const GaugeComponent: ZMPPlugin;
