...
export namespace Messagebar {
  interface Messagebar extends ZMPEventsClass<Events> {
    /** Messagebar HTML element. */
    el: HTMLElement;
    /** zmpDOM element with messagebar HTML element. */
    $el: zmpDOMArray;
    /** Messagebar textarea HTML element */
    textareaEl: HTMLTextAreaElement;
    /** zmpDOM element with messagebar textarea HTML element */
    $textareaEl: zmpDOMArray;
...
declare const MessagebarComponent: ZMPPlugin;
