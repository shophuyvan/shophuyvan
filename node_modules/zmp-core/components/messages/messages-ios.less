.ios {
  ...
  .message-image {
    margin: var(--zmp-message-bubble-padding-vertical)
      calc(-1 * var(--zmp-message-bubble-padding-horizontal));
    &:first-child {
      margin-top: calc(-1 * var(--zmp-message-bubble-padding-vertical));
      img {
        border-top-left-radius: var(--zmp-message-bubble-border-radius);
        border-top-right-radius: var(--zmp-message-bubble-border-radius);
      }
    }
    &:last-child {
      margin-bottom: calc(-1 * var(--zmp-message-bubble-padding-vertical));
      img {
        border-bottom-left-radius: var(--zmp-message-bubble-border-radius);
        border-bottom-right-radius: var(--zmp-message-bubble-border-radius);
      }
    }
  }
  .message-text-header {
  ...
  .message-received {
    margin-left: calc(10px + var(--zmp-safe-area-left));
    .message-header,
    .message-footer,
    .message-name {
      margin-left: var(--zmp-message-bubble-padding-horizontal);
    }
    .message-bubble {
      padding-left: calc(var(--zmp-message-bubble-padding-horizontal) + 6px);
    ...
    .message-image {
      margin-left: calc(-1 * (var(--zmp-message-bubble-padding-horizontal) + 6px));
    }
  ...
  .message-sent {
    margin-right: calc(10px + var(--zmp-safe-area-right));
    .message-header,
    .message-footer,
    .message-name {
      margin-right: var(--zmp-message-bubble-padding-horizontal);
    }
    .message-bubble {
      padding-right: calc(var(--zmp-message-bubble-padding-horizontal) + 6px);
    ...
    .message-image {
      margin-right: calc(-1 * (var(--zmp-message-bubble-padding-horizontal) + 6px));
    }
  ...
  .message-received.message-typing {
    .message-content {
      ...
      &:before {
        content: '';
        position: absolute;
        background: var(--zmp-message-received-bg-color);
        border-radius: 50%;
      }
      &:after {
        width: 11px;
