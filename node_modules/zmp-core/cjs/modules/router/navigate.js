...
function forward(router, el, forwardOptions) {
  ...
  if (options.reloadCurrent || reloadDetail) {
    if (reloadDetail) {
      ...
      if (dynamicNavbar) {
        $oldNavbarEl = (0, _zmpDom.default)($oldPage.map(function (pageEl) {
      ...
      if ($oldPage.length > 1 && masterPageEl) {
        ...
        (0, _zmpDom.default)(masterPageEl).removeClass('page-master-stacked').trigger('page:masterunstack');
        router.emit('pageMasterUnstack', masterPageEl);

        if (dynamicNavbar) {
          (0, _zmpDom.default)(app.navbar.getElByPage(masterPageEl)).removeClass('navbar-master-stacked');
      ...
      if (dynamicNavbar) {
        $oldNavbarEl = (0, _zmpDom.default)(app.navbar.getElByPage($oldPage));
      }
    }
  } else if (options.reloadPrevious) {
    ...
    if ($pagesInView.length > 1) {
      ...
      for (_i2 = 0; _i2 < $pagesInView.length - 1; _i2 += 1) {
        if (masterPageEl && $pagesInView[_i2] === masterPageEl) {
          ...
          if (dynamicNavbar) {
            (0, _zmpDom.default)(app.navbar.getElByPage(masterPageEl)).addClass('navbar-master-stacked');
        ...
        if (router.params.stackPages) {
          ...
          if (dynamicNavbar) {
            (0, _zmpDom.default)(oldNavbarEl).addClass('stacked');
          }
        } else {
          // Page remove event
  ...
  if ((options.reloadCurrent || reloadDetail) && $oldPage.length > 0) {
    ...
    $oldPage.each(function (pageEl, index) {
      var $oldPageEl = (0, _zmpDom.default)(pageEl);
      var $oldNavbarElEl = (0, _zmpDom.default)(app.navbar.getElByPage($oldPageEl));
  ...
  if (options.reloadCurrent || options.reloadAll || reloadDetail) {
    ...
    if (reloadDetail) {
      router.setPagePosition((0, _zmpDom.default)(masterPageEl), 'previous');

      if (masterPageEl.zmpPage && masterPageEl.zmpPage.navbarEl) {
        router.setNavbarPosition((0, _zmpDom.default)(masterPageEl.zmpPage.navbarEl), 'previous');
      }
    }
