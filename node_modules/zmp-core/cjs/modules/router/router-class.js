...
var Router = /*#__PURE__*/function (_ZMPClass) {
  ...
  _proto.animatableNavElements = function animatableNavElements($newNavbarEl, $oldNavbarEl, toLarge, fromLarge, direction) {
    ...
    if (dynamicNavbar) {
      ...
      $newNavbarEl.children('.navbar-inner').children('.left, .right, .title, .subnavbar').each(function (navEl) {
        var $navEl = (0, _zmpDom.default)(navEl);
  ...
  _proto.removeTabContent = function removeTabContent(tabEl) {
    var $tabEl = (0, _zmpDom.default)(tabEl);
    $tabEl.html('');
  };
  ...
  _proto.removeEl = function removeEl(el) {
    ...
    $el.find('.tab').each(function (tabEl) {
      (0, _zmpDom.default)(tabEl).children().each(function (tabChild) {
        if (tabChild.zmpComponent) {
          (0, _zmpDom.default)(tabChild).trigger('tab:beforeremove');
  ...
  _proto.getPageEl = function getPageEl(content) {
    ...
    if (typeof content === 'string') {
      ...
      if ((0, _zmpDom.default)(content).hasClass('page')) {
        return content;
      }

      router.tempDom.innerHTML = '';
      (0, _zmpDom.default)(router.tempDom).append(content);
    }
  ...
  _proto.findElement = function findElement(stringSelector, container, notStacked) {
    ...
    var $container = (0, _zmpDom.default)(container);
    var selector = stringSelector;
    if (notStacked) selector += ':not(.stacked)';
    var found = $container.find(selector).filter(function (el) {
      return (0, _zmpDom.default)(el).parents(modalsSelector).length === 0;
    });
    ...
    if (found && found.length > 1) return (0, _zmpDom.default)(found[0]);
    return undefined;
  };
  ...
  _proto.removeThemeElements = function removeThemeElements(el) {
    ...
    (0, _zmpDom.default)(el).find(toRemove).remove();
  };
  ...
  _proto.getPageData = function getPageData(pageEl, navbarEl, from, to, route, pageFromEl) {
    ...
    var router = this;
    var $pageEl = (0, _zmpDom.default)(pageEl).eq(0);
    var $navbarEl = (0, _zmpDom.default)(navbarEl).eq(0);
    ...
    if (currentPage && !currentPage.fromPage) {
      var $pageFromEl = (0, _zmpDom.default)(pageFromEl);
  ...
  _proto.pageCallback = function pageCallback(callback, pageEl, navbarEl, from, to, options, pageFromEl) {
    ...
    if (!pageEl) return;
    var router = this;
    var $pageEl = (0, _zmpDom.default)(pageEl);
    if (!$pageEl.length) return;
    var $navbarEl = (0, _zmpDom.default)(navbarEl);
    ...
    if (callback === 'beforeRemove' && $pageEl[0].zmpPage) {
      page = (0, _utils.extend)($pageEl[0].zmpPage, {
        from: from,
        to: to,
        position: from
      });
    ...
    function detachEvents() {
      ...
      if ($pageEl[0].zmpRouteEventsOn) {
        Object.keys($pageEl[0].zmpRouteEventsOn).forEach(function (eventName) {
          $pageEl.off((0, _utils.eventNameToColonCase)(eventName), $pageEl[0].zmpRouteEventsOn[eventName]);
        });
      }

      if ($pageEl[0].zmpRouteEventsOnce) {
        Object.keys($pageEl[0].zmpRouteEventsOnce).forEach(function (eventName) {
          $pageEl.off((0, _utils.eventNameToColonCase)(eventName), $pageEl[0].zmpRouteEventsOnce[eventName]);
        });
      }
      ...
      if (restoreScrollTopOnBack && (from === 'previous' || !from) && to === 'current' && router.scrollHistory[page.route.url] && !$pageEl.hasClass('no-restore-scroll')) {
        ...
        if ($pageContent.length > 0) {
          ...
          $pageContent = $pageContent.filter(function (pageContentEl) {
            return (0, _zmpDom.default)(pageContentEl).parents('.tab:not(.tab-active)').length === 0 && !(0, _zmpDom.default)(pageContentEl).is('.tab:not(.tab-active)');
          });
        }
