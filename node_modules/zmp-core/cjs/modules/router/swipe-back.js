...
function SwipeBack(r) {
    ...
    if (params.iosAnimateNavbarBackIcon) {
      ...
      if (activeNavBackIconText.length) {
        $previousNavElements.each(function (el) {
          if (!(0, _zmpDom.default)(el).hasClass('title')) return;
  ...
  function handleTouchStart(e) {
    ...
    if ((0, _zmpDom.default)(e.target).closest('.range-slider, .calendar-months').length > 0) return;
    if ((0, _zmpDom.default)(e.target).closest('.page-master, .page-master-detail').length > 0 && params.masterDetailBreakpoint > 0 && app.width >= params.masterDetailBreakpoint) return;
    isMoved = false;
    isTouched = true;
  ...
  function handleTouchMove(e) {
    ...
    if (!isMoved) {
      ...
      var cancel = false;
      var target = (0, _zmpDom.default)(e.target);
      ...
      if (paramsSwipeBackAnimateShadow) {
        ...
        if ($pageShadowEl.length === 0) {
          $pageShadowEl = (0, _zmpDom.default)('<div class="page-shadow-effect"></div>');
      ...
      if (paramsSwipeBackAnimateOpacity) {
        ...
        if ($pageOpacityEl.length === 0) {
          $pageOpacityEl = (0, _zmpDom.default)('<div class="page-opacity-effect"></div>');
      ...
      if ((0, _zmpDom.default)('.sheet.modal-in').length > 0 && app.sheet) {
        app.sheet.close((0, _zmpDom.default)('.sheet.modal-in'));
      }
    }
    ...
    (0, _zmpDom.default)([$currentPageEl[0], $previousPageEl[0]]).addClass('page-swipeback-active');
  ...
  function handleTouchEnd(e) {
    ...
    var $pages = (0, _zmpDom.default)([$currentPageEl[0], $previousPageEl[0]]);
