...
function tabLoad(tabRoute, loadOptions) {
  ...
  var $parentPageEl = (0, _zmpDom.default)(options.parentPageEl || router.currentPageEl);
  var tabEl;
  ...
  function onTabLoaded(contentEl) {
    ...
    if (typeof contentEl !== 'string') tabEventTarget = (0, _zmpDom.default)(contentEl);
...
function tabRemove($oldTabEl, $newTabEl, tabRoute) {
  ...
  $oldTabEl.children().each(function (tabChild) {
    if (tabChild.zmpComponent) {
      ...
      (0, _zmpDom.default)(tabChild).trigger('tab:beforeremove', tabRoute);
