...
function initTouch() {
  ...
  function findActivableElement(el) {
    var target = (0, _zmpDom.default)(el);
    ...
    if (activable && activable.length > 1) {
      ...
      activable = (0, _zmpDom.default)(newActivable);
    }
  ...
  function handleMouseDown(e) {
    ...
    if ($activableEl) {
      ...
      if ('which' in e && e.which === 3) {
        setTimeout(function () {
          (0, _zmpDom.default)('.active-state').removeClass('active-state');
        }, 0);
      }
    }
  ...
  function handleTouchStart(e) {
    ...
    if (params.tapHold) {
      ...
      tapHoldTimeout = setTimeout(function () {
        ...
        e.preventDefault();
        preventClick = true;
        (0, _zmpDom.default)(e.target).trigger('taphold', e);
        app.emit('taphold', e);
      }, params.tapHoldDelay);
    }
