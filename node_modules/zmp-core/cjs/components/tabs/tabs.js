...
var Tab = {
  show: function show() {
    ...
    var $newTabEl = (0, _zmpDom.default)(tabEl);

    if (tabRoute && $newTabEl[0]) {
      $newTabEl[0].zmpTabRoute = tabRoute;
    }
    ...
    var $tabLinkEl;
    if (tabLinkEl) $tabLinkEl = (0, _zmpDom.default)(tabLinkEl);
    ...
    if (!animatedInit && (!swiper || swiper && !swiper.animating || swiper && tabRoute)) {
      if ($oldTabEl.hasClass('view') && $oldTabEl.children('.page').length) {
        $oldTabEl.children('.page').each(function (pageEl) {
          (0, _zmpDom.default)(pageEl).trigger('page:tabhide');
    ...
    if (!animatedInit && (!swiper || swiper && !swiper.animating || swiper && tabRoute)) {
      if ($newTabEl.hasClass('view') && $newTabEl.children('.page').length) {
        $newTabEl.children('.page').each(function (pageEl) {
          (0, _zmpDom.default)(pageEl).trigger('page:tabshow');
    ...
    if (!$tabLinkEl) {
      // Search by id
      if (typeof tabEl === 'string') $tabLinkEl = (0, _zmpDom.default)(".tab-link[href=\"" + tabEl + "\"]");else $tabLinkEl = (0, _zmpDom.default)(".tab-link[href=\"#" + $newTabEl.attr('id') + "\"]"); // Search by data-tab

      if (!$tabLinkEl || $tabLinkEl && $tabLinkEl.length === 0) {
        (0, _zmpDom.default)('[data-tab]').each(function (el) {
          if ($newTabEl.is((0, _zmpDom.default)(el).attr('data-tab'))) $tabLinkEl = (0, _zmpDom.default)(el);
        });
      }

      if (tabRoute && (!$tabLinkEl || $tabLinkEl && $tabLinkEl.length === 0)) {
        $tabLinkEl = (0, _zmpDom.default)("[data-route-tab-id=\"" + tabRoute.route.tab.id + "\"]");

        if ($tabLinkEl.length === 0) {
          $tabLinkEl = (0, _zmpDom.default)(".tab-link[href=\"" + tabRoute.url + "\"]");
        }
      }
      ...
      if ($tabLinkEl.length > 1 && $newTabEl.parents('.page').length) {
        ...
        $tabLinkEl = $tabLinkEl.filter(function (tabLinkElement) {
          return (0, _zmpDom.default)(tabLinkElement).parents('.page')[0] === $newTabEl.parents('.page')[0];
        });

        if (app.theme === 'ios' && $tabLinkEl.length === 0 && tabRoute) {
          var $pageEl = $newTabEl.parents('.page');
          var $navbarEl = (0, _zmpDom.default)(app.navbar.getElByPage($pageEl));
    ...
    if ($tabLinkEl.length > 0) {
      ...
      if ($oldTabEl && $oldTabEl.length > 0) {
        ...
        if (oldTabId) {
          $oldTabLinkEl = (0, _zmpDom.default)(".tab-link[href=\"#" + oldTabId + "\"]"); // Search by data-route-tab-id

          if (!$oldTabLinkEl || $oldTabLinkEl && $oldTabLinkEl.length === 0) {
            $oldTabLinkEl = (0, _zmpDom.default)(".tab-link[data-route-tab-id=\"" + oldTabId + "\"]");
          }
        } // Search by data-tab


        if (!$oldTabLinkEl || $oldTabLinkEl && $oldTabLinkEl.length === 0) {
          (0, _zmpDom.default)('[data-tab]').each(function (tabLinkElement) {
            if ($oldTabEl.is((0, _zmpDom.default)(tabLinkElement).attr('data-tab'))) $oldTabLinkEl = (0, _zmpDom.default)(tabLinkElement);
          });
        }
      ...
      if ($oldTabLinkEl && $oldTabLinkEl.length > 1 && $oldTabEl && $oldTabEl.parents('.page').length) {
        ...
        $oldTabLinkEl = $oldTabLinkEl.filter(function (tabLinkElement) {
          return (0, _zmpDom.default)(tabLinkElement).parents('.page')[0] === $oldTabEl.parents('.page')[0];
        });
      }
...
var _default = {
  ...
  on: {
    'pageInit tabMounted': function onInit(pageOrTabEl) {
      var $el = (0, _zmpDom.default)(pageOrTabEl.el || pageOrTabEl);
