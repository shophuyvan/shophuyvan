...
var Preloader = {
  ...
  show: function show(color) {
    ...
    (0, _zmpDom.default)('html').addClass('with-modal-preloader'); // prettier-ignore
  ...
  showIn: function showIn(el, color) {
    ...
    var preloaderInner = preloaders[app.theme + "PreloaderContent"] || '';
    (0, _zmpDom.default)(el || 'html').addClass('with-modal-preloader'); // prettier-ignore

    (0, _zmpDom.default)(el || app.$el).append("\n      <div class=\"preloader-backdrop\"></div>\n      <div class=\"preloader-modal\">\n        <div class=\"preloader color-" + color + "\">" + preloaderInner + "</div>\n      </div>\n    ");
  },
  hide: function hide() {
    var app = this;
    if (!Preloader.visible) return;
    (0, _zmpDom.default)('html').removeClass('with-modal-preloader');
    app.$el.find('.preloader-backdrop, .preloader-modal').remove();
    Preloader.visible = false;
  },
  hideIn: function hideIn(el) {
    var app = this;
    (0, _zmpDom.default)(el || 'html').removeClass('with-modal-preloader');
    (0, _zmpDom.default)(el || app.$el).find('.preloader-backdrop, .preloader-modal').remove();
  }
};
var _default = {
  name: 'preloader',
  ...
  on: {
    ...
    tabMounted: function tabMounted(tabEl) {
      var app = this;
      (0, _zmpDom.default)(tabEl).find('.preloader').each(function (preloaderEl) {
        app.preloader.init(preloaderEl);
      });
    },
