...
var _default = {
  ...
  on: {
    tabMounted: function tabMounted(tabEl) {
      var app = this;
      (0, _zmpDom.default)(tabEl).find('.searchbar-init').each(function (searchbarEl) {
        var $searchbarEl = (0, _zmpDom.default)(searchbarEl);
    ...
    tabBeforeRemove: function tabBeforeRemove(tabEl) {
      (0, _zmpDom.default)(tabEl).find('.searchbar-init').each(function (searchbarEl) {
        if (searchbarEl.zmpSearchbar && searchbarEl.zmpSearchbar.destroy) {
          searchbarEl.zmpSearchbar.destroy();
        }
      });
    },
