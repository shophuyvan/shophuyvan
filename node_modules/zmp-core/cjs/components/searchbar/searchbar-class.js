...
var Searchbar = /*#__PURE__*/function (_FrameworkClass) {
  ...
  function Searchbar(app, params) {
    ...
    var $el = (0, _zmpDom.default)(sb.params.el);
    if ($el.length === 0) return sb || _assertThisInitialized(_this);
    if ($el[0].zmpSearchbar) return $el[0].zmpSearchbar || _assertThisInitialized(_this);
    $el[0].zmpSearchbar = sb;
    var $pageEl;
    ...
    if ($el.parents('.page').length > 0) {
      ...
      $pageEl = (0, _zmpDom.default)(app.navbar.getPageByEl($navbarEl[0]));

      if (!$pageEl.length) {
        var $currentPageEl = $el.parents('.view').find('.page-current');

        if ($currentPageEl[0] && $currentPageEl[0].zmpPage && $currentPageEl[0].zmpPage.navbarEl === $navbarEl[0]) {
    ...
    if (params.foundEl) {
      $foundEl = (0, _zmpDom.default)(params.foundEl);
    ...
    if (params.notFoundEl) {
      $notFoundEl = (0, _zmpDom.default)(params.notFoundEl);
    ...
    if (params.hideOnEnableEl) {
      $hideOnEnableEl = (0, _zmpDom.default)(params.hideOnEnableEl);
    ...
    if (params.hideOnSearchEl) {
      $hideOnSearchEl = (0, _zmpDom.default)(params.hideOnSearchEl);
    ...
    if (sb.params.backdrop) {
      if (sb.params.backdropEl) {
        $backdropEl = (0, _zmpDom.default)(sb.params.backdropEl);
      ...
      if ($backdropEl.length === 0) {
        $backdropEl = (0, _zmpDom.default)('<div class="searchbar-backdrop"></div>');
    ...
    if (sb.params.searchContainer) {
      $searchContainer = (0, _zmpDom.default)(sb.params.searchContainer);
    }

    var $inputEl;

    if (sb.params.inputEl) {
      $inputEl = (0, _zmpDom.default)(sb.params.inputEl);
    } else {
    ...
    if (sb.params.disableButton) {
      if (sb.params.disableButtonEl) {
        $disableButtonEl = (0, _zmpDom.default)(sb.params.disableButtonEl);
      } else {
  ...
  _proto.clear = function clear(e) {
    ...
    if (!sb.query && e && (0, _zmpDom.default)(e.target).hasClass('searchbar-clear')) {
      sb.disable();
      return sb;
    }
  ...
  _proto.search = function search(query, internal) {
    ...
    if (isVirtualList) {
      sb.virtualList = $searchContainer[0].zmpVirtualList;
      ...
      $searchContainer.find(sb.params.searchItem).removeClass('hidden-by-searchbar').each(function (itemEl) {
        var $itemEl = (0, _zmpDom.default)(itemEl);
        var compareWithText = [];
        ...
        $searchIn.each(function (searchInEl) {
          var itemText = (0, _zmpDom.default)(searchInEl).text().trim().toLowerCase();
      ...
      if (sb.params.hideDividers) {
        $searchContainer.find(sb.params.searchGroupTitle).each(function (titleEl) {
          var $titleEl = (0, _zmpDom.default)(titleEl);
      ...
      if (sb.params.hideGroups) {
        $searchContainer.find(sb.params.searchGroup).each(function (groupEl) {
          var $groupEl = (0, _zmpDom.default)(groupEl);
          ...
          var notHidden = $groupEl.find(sb.params.searchItem).filter(function (el) {
            return !(0, _zmpDom.default)(el).hasClass('hidden-by-searchbar');
          });
  ...
  _proto.destroy = function destroy() {
    ...
    if (sb.$el[0]) {
      sb.$el[0].zmpSearchbar = null;
      delete sb.$el[0].zmpSearchbar;
    }
