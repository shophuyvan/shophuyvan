...
var Messagebar = /*#__PURE__*/function (_ZMPClass) {
  _inheritsLoose(Messagebar, _ZMPClass);
  ...
  function Messagebar(app, params) {
    ...
    var $el = (0, _zmpDom.default)(messagebar.params.el);
    if ($el.length === 0) return messagebar || _assertThisInitialized(_this);
    if ($el[0].zmpMessagebar) return $el[0].zmpMessagebar || _assertThisInitialized(_this);
    $el[0].zmpMessagebar = messagebar; // Page and PageContent
    ...
    if (messagebar.params.textareaEl) {
      $textareaEl = (0, _zmpDom.default)(messagebar.params.textareaEl);
    } else {
    ...
    function onAttachmentClick(e) {
      var index = (0, _zmpDom.default)(this).index();

      if ((0, _zmpDom.default)(e.target).closest('.messagebar-attachment-delete').length) {
        (0, _zmpDom.default)(this).trigger('messagebar:attachmentdelete', index);
        messagebar.emit('local::attachmentDelete messagebarAttachmentDelete', messagebar, this, index);
      } else {
        (0, _zmpDom.default)(this).trigger('messagebar:attachmentclick', index);
  ...
  _proto.attachmentsCreate = function attachmentsCreate(innerHTML) {
    ...
    var messagebar = this;
    var $attachmentsEl = (0, _zmpDom.default)("<div class=\"messagebar-attachments\">" + innerHTML + "</div>");
  ...
  _proto.sheetCreate = function sheetCreate(innerHTML) {
    ...
    var messagebar = this;
    var $sheetEl = (0, _zmpDom.default)("<div class=\"messagebar-sheet\">" + innerHTML + "</div>");
  ...
  _proto.destroy = function destroy() {
    ...
    if (messagebar.$el[0]) {
      messagebar.$el[0].zmpMessagebar = null;
      delete messagebar.$el[0].zmpMessagebar;
    }
