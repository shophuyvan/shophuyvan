...
var Autocomplete = /*#__PURE__*/function (_ZMPClass) {
  _inheritsLoose(Autocomplete, _ZMPClass);
  ...
  function Autocomplete(app, params) {
    ...
    if (ac.params.openerEl) {
      $openerEl = (0, _zmpDom.default)(ac.params.openerEl);
      if ($openerEl.length) $openerEl[0].zmpAutocomplete = ac;
    }

    var $inputEl;

    if (ac.params.inputEl) {
      $inputEl = (0, _zmpDom.default)(ac.params.inputEl);
      if ($inputEl.length) $inputEl[0].zmpAutocomplete = ac;
    }
    ...
    function onPageInputChange() {
      ...
      var isValues = (0, _zmpDom.default)(inputEl).parents('.autocomplete-values').length > 0;
      var item;
      var itemValue;
      var aValue;
    ...
    ac.attachEvents = function attachEvents() {
      ...
      if (ac.params.openIn === 'dropdown' && ac.$inputEl) {
        ...
        if (device.android) {
          (0, _zmpDom.default)('html').on('click', onHtmlClick);
        } else {
    ...
    ac.detachEvents = function attachEvents() {
      ...
      if (ac.params.openIn === 'dropdown' && ac.$inputEl) {
        ...
        if (device.android) {
          (0, _zmpDom.default)('html').off('click', onHtmlClick);
        } else {
  ...
  _proto.positionDropdown = function positionDropdown() {
    ...
    $listEl.parents().each(function (parentEl) {
      ...
      var $parentEl = (0, _zmpDom.default)(parentEl);
  ...
  _proto.preloaderHide = function preloaderHide() {
    ...
    if (ac.params.openIn === 'dropdown' && ac.$dropdownEl) {
      ...
      (0, _zmpDom.default)('.autocomplete-preloader').removeClass('autocomplete-preloader-visible');
    }
  };
  ...
  _proto.preloaderShow = function preloaderShow() {
    ...
    if (ac.params.openIn === 'dropdown' && ac.$dropdownEl) {
      ...
      (0, _zmpDom.default)('.autocomplete-preloader').addClass('autocomplete-preloader-visible');
    }
  };
  ...
  _proto.onOpen = function onOpen(type, el) {
    ...
    if (ac.params.openIn === 'dropdown') {
      ...
      if (ac.params.openIn === 'page' && app.theme === 'ios' && $searchbarEl.length === 0) {
        $searchbarEl = (0, _zmpDom.default)(app.navbar.getElByPage($el)).find('.searchbar');
      }
  ...
  _proto.openDropdown = function openDropdown() {
    ...
    if (!ac.$dropdownEl) {
      ac.$dropdownEl = (0, _zmpDom.default)(ac.renderDropdown());
    }
    ...
    if (ac.params.dropdownContainerEl) {
      (0, _zmpDom.default)(ac.params.dropdownContainerEl).append(ac.$dropdownEl);
  ...
  _proto.destroy = function destroy() {
    ...
    if (ac.$inputEl && ac.$inputEl[0]) {
      delete ac.$inputEl[0].zmpAutocomplete;
    }

    if (ac.$openerEl && ac.$openerEl[0]) {
      delete ac.$openerEl[0].zmpAutocomplete;
    }
  ...
  _createClass(Autocomplete, [{
    ...
    get: function get() {
      ...
      if (ac.params.view) {
        ...
        view = $el.closest('.view').length && $el.closest('.view')[0].zmpView;
      }
