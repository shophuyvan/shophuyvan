...
var PullToRefresh = /*#__PURE__*/function (_ZMPClass) {
  _inheritsLoose(PullToRefresh, _ZMPClass);

  function PullToRefresh(app, el) {
    var _this;

    _this = _ZMPClass.call(this, {}, [app]) || this;
    ...
    if (!ptr.bottom) {
      ...
      if (pageNavbarEl) {
        var $pageNavbarEl = (0, _zmpDom.default)(pageNavbarEl);
    ...
    function handleTouchStart(e) {
      ...
      if ((0, _zmpDom.default)(e.target).closest('.sortable-handler, .ptr-ignore, .card-expandable.card-opened').length) return;
      isMoved = false;
      pullStarted = false;
      isTouched = true;
    ...
    function handleTouchMove(e) {
      ...
      if (!isMoved) {
        ...
        var $ptrWatchScrollable = (0, _zmpDom.default)(e.target).closest('.ptr-watch-scroll');

        if ($ptrWatchScrollable.length) {
          $ptrWatchScrollable.each(function (ptrScrollableEl) {
            if (ptrScrollableEl === el) return;

            if (ptrScrollableEl.scrollHeight > ptrScrollableEl.offsetHeight && (0, _zmpDom.default)(ptrScrollableEl).css('overflow') === 'auto' && (!ptr.bottom && ptrScrollableEl.scrollTop > 0 || ptr.bottom && ptrScrollableEl.scrollTop < ptrScrollableEl.scrollHeight - ptrScrollableEl.offsetHeight)) {
    ...
    $el[0].zmpPullToRefresh = ptr; // Events
  ...
  _proto.destroy = function destroy() {
    ...
    delete ptr.el.zmpPullToRefresh;
    ptr.detachEvents();
