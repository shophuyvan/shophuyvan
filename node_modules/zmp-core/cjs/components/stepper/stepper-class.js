...
var Stepper = /*#__PURE__*/function (_ZMPClass) {
  _inheritsLoose(Stepper, _ZMPClass);
  ...
  function Stepper(app, params) {
    ...
    if ($el[0].zmpStepper) return $el[0].zmpStepper || _assertThisInitialized(_this);
    var $inputEl;

    if (stepper.params.inputEl) {
      $inputEl = (0, _zmpDom.default)(stepper.params.inputEl);
    ...
    if (stepper.params.valueEl) {
      $valueEl = (0, _zmpDom.default)(stepper.params.valueEl);
    ...
    $el[0].zmpStepper = stepper; // Handle Events
    ...
    function onTouchStart(e) {
      ...
      if ((0, _zmpDom.default)(e.target).closest($buttonPlusEl).length) {
        autorepeatAction = 'increment';
      } else if ((0, _zmpDom.default)(e.target).closest($buttonMinusEl).length) {
    ...
    function onInput(e) {
      ...
      if (e.detail && e.detail.sentByZMPStepper) return;
  ...
  _proto.destroy = function destroy() {
    ...
    delete stepper.$el[0].zmpStepper;
