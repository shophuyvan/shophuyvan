...
var Sortable = {
  init: function init() {
    ...
    function handleTouchStart(e, isTapHold) {
      ...
      $sortingEl = (0, _zmpDom.default)(e.target).closest('li').eq(0);
    ...
    function handleTouchMove(e) {
      ...
      $sortingItems.each(function (el) {
        var $currentEl = (0, _zmpDom.default)(el);
    ...
    function handleTouchEnd() {
      ...
      if (($insertAfterEl || $insertBeforeEl) && $sortableContainer.hasClass('virtual-list')) {
        ...
        var virtualList = $sortableContainer[0].zmpVirtualList;
    ...
    (0, _zmpDom.default)(document).on(app.touchEvents.start, '.list.sortable .sortable-handler', handleTouchStart, activeListener);
    app.on('touchmove:active', handleTouchMove);
    app.on('touchend:passive', handleTouchEnd);
    (0, _zmpDom.default)(document).on('taphold', '.sortable-tap-hold', function (e, pointerEvent) {
