...
var TouchRipple = /*#__PURE__*/function () {
  function TouchRipple(app, $el, x, y) {
    ...
    ripple.$rippleWaveEl = (0, _zmpDom.default)("<div class=\"ripple-wave\" style=\"width: " + diameter + "px; height: " + diameter + "px; margin-top:-" + diameter / 2 + "px; margin-left:-" + diameter / 2 + "px; left:" + center.x + "px; top:" + center.y + "px; --zmp-ripple-transform: " + ripple.rippleTransform + "\"></div>");
