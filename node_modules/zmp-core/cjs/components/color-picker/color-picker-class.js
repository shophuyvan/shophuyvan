...
var ColorPicker = /*#__PURE__*/function (_ZMPClass) {
  _inheritsLoose(ColorPicker, _ZMPClass);
  ...
  function ColorPicker(app, params) {
    ...
    if (self.params.containerEl) {
      $containerEl = (0, _zmpDom.default)(self.params.containerEl);
    ...
    if (self.params.inputEl) {
      $inputEl = (0, _zmpDom.default)(self.params.inputEl);
    }

    var $targetEl;

    if (self.params.targetEl) {
      $targetEl = (0, _zmpDom.default)(self.params.targetEl);
    }
    ...
    function onHtmlClick(e) {
      ...
      var $clickTargetEl = (0, _zmpDom.default)(e.target);
      ...
      } else if ((0, _zmpDom.default)(e.target).closest('.sheet-modal').length === 0) {
        self.close();
      }
    } // Events
    ...
    (0, _utils.extend)(self, {
      attachInputEvents: function attachInputEvents() {
        ...
        if (self.params.inputReadOnly) {
          ...
          if (self.$inputEl[0]) {
            self.$inputEl[0].zmpValidateReadonly = true;
          }
        }
      },
      detachInputEvents: function detachInputEvents() {
        ...
        if (self.params.inputReadOnly) {
          ...
          if (self.$inputEl[0]) {
            delete self.$inputEl[0].zmpValidateReadonly;
          }
        }
      },
  ...
  _proto.open = function open() {
    ...
    if (inline) {
      self.$el = (0, _zmpDom.default)(self.render());
      self.$el[0].zmpColorPicker = self;
          ...
          on: {
            ...
            pageAfterOut: function pageAfterOut() {
              ...
              if (self.$el && self.$el[0]) {
                self.$el[0].zmpColorPicker = null;
                delete self.$el[0].zmpColorPicker;
              }
            }
          }
        }
  ...
  _proto.destroy = function destroy() {
    ...
    if ($el && $el.length) delete self.$el[0].zmpColorPicker;
  ...
  _createClass(ColorPicker, [{
    ...
    get: function get() {
      ...
      if (params.view) {
        ...
        if (!view && $targetEl) {
          view = $targetEl.parents('.view').length && $targetEl.parents('.view')[0].zmpView;
        }
      }
