...
var PieChart = /*#__PURE__*/function (_ZMPClass) {
  _inheritsLoose(PieChart, _ZMPClass);
  ...
  function PieChart(app, params) {
    ...
    if ($el[0].zmpPieChart) return $el[0].zmpPieChart || _assertThisInitialized(_this);
    ...
    $el[0].zmpPieChart = self; // Install Modules
  ...
  _proto.setTooltip = function setTooltip() {
    ...
    if (currentIndex === null && !self.zmpTooltip) return;
    ...
    if (!self.zmpTooltip) return;

    if (currentIndex !== null) {
      self.zmpTooltip.setText(self.formatTooltipText());
      self.zmpTooltip.setTargetEl(el.querySelector("path[data-index=\"" + currentIndex + "\"]"));
      self.zmpTooltip.show();
    } else {
  ...
  _proto.update = function update(newParams) {
    ...
    self.$svgEl.remove();
    delete self.$svgEl.zmpPieChart;
    var $svgEl = (0, _zmpDom.default)(self.render()).eq(0);
    $svgEl.zmpPieChart = self;
    (0, _utils.extend)(self, {
      $svgEl: $svgEl,
      svgEl: $svgEl && $svgEl[0]
    });
  ...
  _proto.showTooltip = function showTooltip(e) {
    ...
    this.$svgEl.find('path').removeClass('pie-chart-hidden').forEach(function (el, index) {
      if (index !== _this3.currentIndex) (0, _zmpDom.default)(el).addClass('pie-chart-hidden');
    });
    this.setTooltip();
  };
