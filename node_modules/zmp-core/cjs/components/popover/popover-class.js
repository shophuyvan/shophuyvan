...
var Popover = /*#__PURE__*/function (_Modal) {
  ...
  function Popover(app, params) {
    ...
    if (!popover.params.el) {
      $el = (0, _zmpDom.default)(popover.params.content).filter(function (node) {
        return node.nodeType === 1;
      }).eq(0);
    } else {
      $el = (0, _zmpDom.default)(popover.params.el).eq(0);
    }
    ...
    var $targetEl = (0, _zmpDom.default)(popover.params.targetEl).eq(0);
    ...
    if (popover.params.backdrop && popover.params.backdropEl) {
      $backdropEl = (0, _zmpDom.default)(popover.params.backdropEl);
    } else if (popover.params.backdrop) {
      $backdropEl = popover.$containerEl.children('.popover-backdrop');

      if ($backdropEl.length === 0) {
        $backdropEl = (0, _zmpDom.default)('<div class="popover-backdrop"></div>');
    ...
    if ($el.find('.popover-angle').length === 0) {
      $angleEl = (0, _zmpDom.default)('<div class="popover-angle"></div>');
      $el.prepend($angleEl);
    } else {
    ...
    (0, _utils.extend)(popover, {
      ...
      open: function open() {
        ...
        if (targetEl) {
          popover.$targetEl = (0, _zmpDom.default)(targetEl);
    ...
    popover.on('popoverOpen', function () {
      ...
      (0, _zmpDom.default)(window).on('keyboardDidShow keyboardDidHide', handleResize);
      popover.on('popoverClose popoverBeforeDestroy', function () {
        app.off('resize', handleResize);
        (0, _zmpDom.default)(window).off('keyboardDidShow keyboardDidHide', handleResize);
      });
    });

    function handleClick(e) {
      var target = e.target;
      var $target = (0, _zmpDom.default)(target);
    ...
    if (popover.params.closeOnEscape) {
      popover.on('popoverOpen', function () {
        (0, _zmpDom.default)(document).on('keydown', onKeyDown);
      });
      popover.on('popoverClose', function () {
        (0, _zmpDom.default)(document).off('keydown', onKeyDown);
      });
    }
  ...
  _proto.resize = function resize() {
    ...
    var targetOffsetTop;
    var safeAreaTop = parseInt((0, _zmpDom.default)('html').css('--zmp-safe-area-top'), 10);
    var safeAreaLeft = parseInt((0, _zmpDom.default)('html').css('--zmp-safe-area-left'), 10);
    var safeAreaRight = parseInt((0, _zmpDom.default)('html').css('--zmp-safe-area-right'), 10);
