...
var Tooltip = /*#__PURE__*/function (_ZMPClass) {
  _inheritsLoose(Tooltip, _ZMPClass);
  ...
  function Tooltip(app, params) {
    ...
    var $targetEl = (0, _zmpDom.default)(targetEl);
    if ($targetEl.length === 0 && !tooltip.params.delegated) return tooltip || _assertThisInitialized(_this);
    if ($targetEl[0] && $targetEl[0].zmpTooltip && !tooltip.params.delegated) return $targetEl[0].zmpTooltip || _assertThisInitialized(_this);
    var $containerEl = (0, _zmpDom.default)(containerEl || app.$el).eq(0);

    if ($containerEl.length === 0) {
      $containerEl = app.$el;
    }

    var $el = (0, _zmpDom.default)(tooltip.render()).eq(0);
    ...
    if ($targetEl[0]) $targetEl[0].zmpTooltip = tooltip;
    var touchesStart = {};
    var isTouched;
    ...
    function handleClickOut(e) {
      if (tooltip.opened && ((0, _zmpDom.default)(e.target).closest($targetEl).length || (0, _zmpDom.default)(e.target).closest(tooltip.$el).length)) return;
      tooltip.hide();
    }
    ...
    tooltip.attachEvents = function attachEvents() {
      ...
      if (tooltip.params.trigger === 'click') {
        if (tooltip.params.delegated) {
          (0, _zmpDom.default)(document).on('click', tooltip.params.targetEl, handleClick);
        } else {
          tooltip.$targetEl.on('click', handleClick);
        }

        (0, _zmpDom.default)('html').on('click', handleClickOut);
        return;
      }
      ...
      if (support.touch) {
        ...
        if (tooltip.params.delegated) {
          (0, _zmpDom.default)(document).on(app.touchEvents.start, tooltip.params.targetEl, handleTouchStart, passive);
        } else {
        ...
        if (tooltip.params.delegated) {
          (0, _zmpDom.default)(document).on(support.pointerEvents ? 'pointerenter' : 'mouseenter', tooltip.params.targetEl, handleMouseEnter, true);
          (0, _zmpDom.default)(document).on(support.pointerEvents ? 'pointerleave' : 'mouseleave', tooltip.params.targetEl, handleMouseLeave, true);
        } else {
    ...
    tooltip.detachEvents = function detachEvents() {
      ...
      if (tooltip.params.trigger === 'click') {
        ...
        (0, _zmpDom.default)('html').off('click', handleClickOut);
        return;
      }
      ...
      if (support.touch) {
        ...
        if (tooltip.params.delegated) {
          (0, _zmpDom.default)(document).off(app.touchEvents.start, tooltip.params.targetEl, handleTouchStart, passive);
        } else {
        ...
        // eslint-disable-next-line
        if (tooltip.params.delegated) {
          (0, _zmpDom.default)(document).off(support.pointerEvents ? 'pointerenter' : 'mouseenter', tooltip.params.targetEl, handleMouseEnter, true);
          (0, _zmpDom.default)(document).off(support.pointerEvents ? 'pointerleave' : 'mouseleave', tooltip.params.targetEl, handleMouseLeave, true);
        } else {
  ...
  _proto.setTargetEl = function setTargetEl(targetEl) {
    ...
    tooltip.$targetEl = (0, _zmpDom.default)(targetEl);
  ...
  _proto.position = function position(targetEl) {
    ...
    var $targetEl = (0, _zmpDom.default)(targetEl || tooltip.targetEl);
  ...
  _proto.show = function show(aroundEl) {
    ...
    var $aroundEl = (0, _zmpDom.default)(aroundEl);
  ...
  _proto.destroy = function destroy() {
    ...
    tooltip.$el.remove();
    if (tooltip.$targetEl[0]) delete tooltip.$targetEl[0].zmpTooltip;
    tooltip.detachEvents();
