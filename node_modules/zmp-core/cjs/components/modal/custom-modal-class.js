...
var CustomModal = /*#__PURE__*/function (_Modal) {
  ...
  function CustomModal(app, params) {
    ...
    if (!customModal.params.el) {
      $el = (0, _zmpDom.default)(customModal.params.content);
    } else {
      $el = (0, _zmpDom.default)(customModal.params.el);
    }
    ...
    if (customModal.params.backdrop) {
      ...
      if ($backdropEl.length === 0) {
        $backdropEl = (0, _zmpDom.default)('<div class="custom-modal-backdrop"></div>');
