...
var Modal = /*#__PURE__*/function (_ZMPClass) {
  ...
  function Modal(app, params) {
    ...
    modal.opened = false;
    var $containerEl = modal.params.containerEl ? (0, _zmpDom.default)(modal.params.containerEl).eq(0) : app.$el;
  ...
  _proto.onOpen = function onOpen() {
    ...
    (0, _zmpDom.default)('html').addClass("with-modal-" + modal.type.toLowerCase());
  ...
  _proto.onClose = function onClose() {
    ...
    (0, _zmpDom.default)('html').removeClass("with-modal-" + modal.type.toLowerCase());
  ...
  _proto.open = function open(animateModal) {
    ...
    if (type === 'dialog' && app.params.modal.queueDialogs) {
      ...
      if ((0, _zmpDom.default)('.dialog.modal-in').length > 0) {
        pushToQueue = true;
