...
var Actions = /*#__PURE__*/function (_Modal) {
  ...
  function Actions(app, params) {
    ...
    if (actions.params.el) {
      $el = (0, _zmpDom.default)(actions.params.el).eq(0);
    } else if (actions.params.content) {
      $el = (0, _zmpDom.default)(actions.params.content).filter(function (node) {
    ...
    if (actions.params.backdrop && actions.params.backdropEl) {
      $backdropEl = (0, _zmpDom.default)(actions.params.backdropEl);
    } else if (actions.params.backdrop) {
      $backdropEl = actions.$containerEl.children('.actions-backdrop');

      if ($backdropEl.length === 0) {
        $backdropEl = (0, _zmpDom.default)('<div class="actions-backdrop"></div>');
    ...
    function buttonOnClick(e) {
      var $buttonEl = (0, _zmpDom.default)(this);
      var buttonIndex;
      var groupIndex;
      ...
      if (convertToPopover && actions.popoverHtml) {
        ...
        popover.once('popoverOpened', function () {
          popover.$el.find('.list-button, .item-link').each(function (buttonEl) {
            (0, _zmpDom.default)(buttonEl).on('click', buttonOnClick);
          });
        });
        popover.once('popoverClosed', function () {
          popover.$el.find('.list-button, .item-link').each(function (buttonEl) {
            (0, _zmpDom.default)(buttonEl).off('click', buttonOnClick);
          });
        ...
        actions.$el = actions.actionsHtml ? (0, _zmpDom.default)(actions.actionsHtml) : actions.$el;
        actions.$el[0].zmpModal = actions;
