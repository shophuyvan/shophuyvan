...
var Gauge = /*#__PURE__*/function (_ZMPClass) {
  _inheritsLoose(Gauge, _ZMPClass);
  ...
  function Gauge(app, params) {
    ...
    if ($el[0].zmpGauge) return $el[0].zmpGauge || _assertThisInitialized(_this);
    (0, _utils.extend)(self, {
      app: app,
      $el: $el,
      el: $el && $el[0]
    });
    $el[0].zmpGauge = self; // Install Modules
