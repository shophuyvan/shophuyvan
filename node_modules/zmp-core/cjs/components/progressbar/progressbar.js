...
var Progressbar = {
  set: function set() {
    ...
    var $el = (0, _zmpDom.default)(el || app.$el);
    ...
    if ($progressbarLine.length === 0) {
      $progressbarLine = (0, _zmpDom.default)('<span></span>');
...
var _default = {
  ...
  on: {
    tabMounted: function tabMounted(tabEl) {
      var app = this;
      (0, _zmpDom.default)(tabEl).find('.progressbar').each(function (progressbarEl) {
        var $progressbarEl = (0, _zmpDom.default)(progressbarEl);
