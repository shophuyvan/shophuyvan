...
var Calendar = /*#__PURE__*/function (_ZMPClass) {
  _inheritsLoose(Calendar, _ZMPClass);
  ...
  function Calendar(app, params) {
    ...
    if (calendar.params.containerEl) {
      $containerEl = (0, _zmpDom.default)(calendar.params.containerEl);
    ...
    if (calendar.params.inputEl) {
      $inputEl = (0, _zmpDom.default)(calendar.params.inputEl);
    }
    ...
    function onHtmlClick(e) {
      var $targetEl = (0, _zmpDom.default)(e.target);
      ...
      } else if ((0, _zmpDom.default)(e.target).closest('.sheet-modal, .calendar-modal').length === 0) {
        calendar.close();
      }
    } // Events
    ...
    (0, _utils.extend)(calendar, {
      attachInputEvents: function attachInputEvents() {
        ...
        if (calendar.params.inputReadOnly) {
          ...
          if (calendar.$inputEl[0]) {
            calendar.$inputEl[0].zmpValidateReadonly = true;
          }
        }
      },
      detachInputEvents: function detachInputEvents() {
        ...
        if (calendar.params.inputReadOnly) {
          ...
          if (calendar.$inputEl[0]) {
            delete calendar.$inputEl[0].zmpValidateReadonly;
          }
        }
      },
    ...
    calendar.attachCalendarEvents = function attachCalendarEvents() {
      ...
      function handleDayClick(e) {
        ...
        var $dayEl = (0, _zmpDom.default)(e.target).parents('.calendar-day');

        if ($dayEl.length === 0 && (0, _zmpDom.default)(e.target).hasClass('calendar-day')) {
          $dayEl = (0, _zmpDom.default)(e.target);
        }
      ...
      function onMonthSelectorItemClick() {
        var $clickedEl = (0, _zmpDom.default)(this);
  ...
  _proto.nextMonth = function nextMonth(transition) {
    ...
    if (nextMonth === calendar.currentMonth) {
      ...
      var nextMonthHtml = (0, _zmpDom.default)(calendar.renderMonth(nextDateTime, 'next')).transform("translate3d(" + (isH ? nextMonthTranslate : 0) + "%, " + (isH ? 0 : nextMonthTranslate) + "%, 0)").addClass('calendar-month-next');
  ...
  _proto.prevMonth = function prevMonth(transition) {
    ...
    if (prevMonth === calendar.currentMonth) {
      ...
      var prevMonthHtml = (0, _zmpDom.default)(calendar.renderMonth(prevDateTime, 'prev')).transform("translate3d(" + (isH ? prevMonthTranslate : 0) + "%, " + (isH ? 0 : prevMonthTranslate) + "%, 0)").addClass('calendar-month-prev');
  ...
  _proto.open = function open() {
    ...
    if (inline) {
      calendar.$el = (0, _zmpDom.default)(calendar.render());
      calendar.$el[0].zmpCalendar = calendar;
      ...
      on: {
        open: function open() {
          ...
          if (modalType === 'customModal') {
            (0, _zmpDom.default)(calendar.$el).find('.calendar-close').once('click', function () {
              calendar.close();
            });
          }
  ...
  _proto.destroy = function destroy() {
    ...
    if ($el && $el.length) delete calendar.$el[0].zmpCalendar;
  ...
  _createClass(Calendar, [{
    ...
    get: function get() {
      ...
      if (params.view) {
        ...
        view = $inputEl.parents('.view').length && $inputEl.parents('.view')[0].zmpView;
      }
