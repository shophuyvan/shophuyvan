...
var Range = /*#__PURE__*/function (_ZMPClass) {
  _inheritsLoose(Range, _ZMPClass);
  ...
  function Range(app, params) {
    ...
    if ($el[0].zmpRange) return $el[0].zmpRange || _assertThisInitialized(_this);
    ...
    if (!range.params.dual) {
      if (range.params.inputEl) {
        $inputEl = (0, _zmpDom.default)(range.params.inputEl);
    ...
    var $barEl = (0, _zmpDom.default)('<div class="range-bar"></div>');
    var $barActiveEl = (0, _zmpDom.default)('<div class="range-bar-active"></div>');
    $barEl.append($barActiveEl); // Create Knobs
    // prettier-ignore

    var knobHTML = "\n      <div class=\"range-knob-wrap\">\n        <div class=\"range-knob\"></div>\n        " + (range.label ? '<div class="range-knob-label"></div>' : '') + "\n      </div>\n    ";
    var knobs = [(0, _zmpDom.default)(knobHTML)];

    if (range.dual) {
      knobs.push((0, _zmpDom.default)(knobHTML));
    }
    ...
    $el[0].zmpRange = range; // Touch Events
    ...
    function handleTouchStart(e) {
      ...
      if (!range.params.draggableBar) {
        if ((0, _zmpDom.default)(e.target).closest('.range-knob').length === 0) {
          return;
        }
      }
  ...
  _proto.updateScale = function updateScale() {
    ...
    if (!range.$scaleEl) {
      range.$scaleEl = (0, _zmpDom.default)('<div class="range-scale"></div>');
