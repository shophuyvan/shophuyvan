...
var ListIndex = /*#__PURE__*/function (_ZMPClass) {
  _inheritsLoose(ListIndex, _ZMPClass);
  ...
  function ListIndex(app, params) {
    ...
    if (index.params.el) {
      $el = (0, _zmpDom.default)(index.params.el);
    } else {
      return index || _assertThisInitialized(_this);
    }

    if ($el[0].zmpListIndex) {
      return $el[0].zmpListIndex || _assertThisInitialized(_this);
    }

    $ul = $el.find('ul');

    if ($ul.length === 0) {
      $ul = (0, _zmpDom.default)('<ul></ul>');
      $el.append($ul);
    }

    if (index.params.listEl) {
      $listEl = (0, _zmpDom.default)(index.params.listEl);
    }
    ...
    function handleClick(e) {
      var $clickedLi = (0, _zmpDom.default)(e.target).closest('li');
    ...
    function handleTouchMove(e) {
      ...
      if (!isMoved && index.params.label) {
        $labelEl = (0, _zmpDom.default)('<span class="list-index-label"></span>');
        $el.append($labelEl);
      }
  ...
  _proto.scrollListToIndex = function scrollListToIndex(itemContent, itemIndex) {
    ...
    if ($pageContentEl.parents('.page-with-navbar-large').length) {
      ...
      var $titleLargeEl = (0, _zmpDom.default)(navbarInnerEl).find('.title-large');
  ...
  _proto.calcIndexes = function calcIndexes() {
    ...
    if (index.params.indexes === 'auto') {
      ...
      index.$listEl.find('.list-group-title, .item-divider').each(function (el) {
        var elContent = (0, _zmpDom.default)(el).text();
  ...
  _proto.destroy = function destroy() {
    ...
    if (index.$el[0]) {
      index.$el[0].zmpListIndex = null;
      delete index.$el[0].zmpListIndex;
    }
