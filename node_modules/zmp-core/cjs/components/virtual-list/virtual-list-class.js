...
var VirtualList = /*#__PURE__*/function (_ZMPClass) {
  _inheritsLoose(VirtualList, _ZMPClass);
  ...
  function VirtualList(app, params) {
    ...
    vl.$scrollableParentEl = vl.params.scrollableParentEl ? (0, _zmpDom.default)(vl.params.scrollableParentEl).eq(0) : vl.$pageContentEl;
    ...
    var ul = vl.params.ul;
    vl.$ul = ul ? (0, _zmpDom.default)(vl.params.ul) : vl.$el.children('ul');
    ...
    vl.attachEvents = function attachEvents() {
      ...
      $tabEl = vl.$el.parents('.tab').filter(function (tabEl) {
        return (0, _zmpDom.default)(tabEl).parent('.tabs').parent('.tabs-animated-wrap, .tabs-swipeable-wrap').length === 0;
      }).eq(0);
  ...
  _proto.setListSize = function setListSize(autoHeightRerender) {
    var vl = this;
  ...
  _proto.render = function render(force, forceScrollTop) {
    ...
    for (i = fromIndex; i < toIndex; i += 1) {
      ...
      if (vl.params.renderExternal) {
        ...
        itemEl.zmpVirtualListIndex = index;
      } else {
        if (vl.renderItem) {
  ...
  _proto.destroy = function destroy() {
    var vl = this;
    vl.detachEvents();
    vl.$el[0].zmpVirtualList = null;
    delete vl.$el[0].zmpVirtualList;
