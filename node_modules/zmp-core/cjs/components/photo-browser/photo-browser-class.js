...
var PhotoBrowser = /*#__PURE__*/function (_ZMPClass) {
  _inheritsLoose(PhotoBrowser, _ZMPClass);
  ...
  _proto.onSlideChange = function onSlideChange(swiper) {
    ...
    if (pb.params.type === 'page' && pb.params.navbar && $currentEl.length === 0 && pb.app.theme === 'ios') {
      ...
      if (navbarEl) {
        $currentEl = (0, _zmpDom.default)(navbarEl).find('.photo-browser-current');
        $totalEl = (0, _zmpDom.default)(navbarEl).find('.photo-browser-total');
      }
    }
    ...
    var swiperParams = (0, _utils.extend)({}, pb.params.swiper, {
      ...
      on: {
        ...
        lazyImageReady: function lazyImageReady() {
          ...
          var slideEl = args[0];
          (0, _zmpDom.default)(slideEl).removeClass('photo-browser-slide-lazy');
  ...
  _proto.destroy = function destroy() {
    ...
    if (pb.$el) {
      ...
      pb.$el[0].zmpPhotoBrowser = null;
      delete pb.$el[0].zmpPhotoBrowser;
    }
