...
var Input = {
  ...
  createTextareaResizableShadow: function createTextareaResizableShadow() {
    ...
    var $shadowEl = (0, _zmpDom.default)(document.createElement('textarea'));
  ...
  resizeTextarea: function resizeTextarea(textareaEl) {
    ...
    var $textareaEl = (0, _zmpDom.default)(textareaEl);
    var rows = $textareaEl.attr('rows');
    ...
    $shadowEl.attr('class', "textarea-resizable-shadow textarea-rows-" + rows);
  ...
  validate: function validate(inputEl) {
    ...
    if (!validity.valid) {
      ...
      if (validationMessage) {
        if ($errorEl.length === 0) {
          $errorEl = (0, _zmpDom.default)("<div class=\"" + ($inputWrapEl.length ? 'input-error-message' : 'item-input-error-message') + "\"></div>");
  ...
  validateInputs: function validateInputs(el) {
    var app = this;
    var validates = (0, _zmpDom.default)(el).find('input, textarea, select').map(function (inputEl) {
  ...
  init: function init() {
    ...
    function onFocus() {
      ...
      if (app.params.input.scrollIntoViewOnFocus) {
        if (device.android) {
          (0, _zmpDom.default)(window).once('resize', function () {
    ...
    function onBlur() {
      var $inputEl = (0, _zmpDom.default)(this);
    ...
    function clearInput() {
      var $clicked = (0, _zmpDom.default)(this);
    ...
    (0, _zmpDom.default)(document).on('click', '.input-clear-button', clearInput);
    (0, _zmpDom.default)(document).on('mousedown', '.input-clear-button', preventDefault);
    (0, _zmpDom.default)(document).on('change input', 'input, textarea, select, .item-input [contenteditable]', onChange, true);
    (0, _zmpDom.default)(document).on('focus', 'input, textarea, select, .item-input [contenteditable]', onFocus, true);
    (0, _zmpDom.default)(document).on('blur', 'input, textarea, select, .item-input [contenteditable]', onBlur, true);
    (0, _zmpDom.default)(document).on('invalid', 'input, textarea, select', onInvalid, true);
  }
};
var _default = {
  name: 'input',
  ...
  on: {
    ...
    tabMounted: function tabMounted(tabEl) {
      ...
      $tabEl.find('.item-input, .input').each(function (itemInputEl) {
        var $itemInputEl = (0, _zmpDom.default)(itemInputEl);
    ...
    'panelBreakpoint panelCollapsedBreakpoint panelResize panelOpen panelSwipeOpen resize viewMasterDetailBreakpoint': function onPanelOpen(instance) {
      ...
      if (instance && instance.$el) {
        ...
        (0, _zmpDom.default)('textarea.resizable').each(function (textareaEl) {
          app.input.resizeTextarea(textareaEl);
        });
      }
    }
