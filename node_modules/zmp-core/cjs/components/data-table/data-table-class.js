...
var DataTable = /*#__PURE__*/function (_ZMPClass) {
  _inheritsLoose(DataTable, _ZMPClass);
  ...
  function DataTable(app, params) {
    ...
    var $el = (0, _zmpDom.default)(table.params.el);
    if ($el.length === 0) return undefined || _assertThisInitialized(_this);
    table.$el = $el;
    table.el = $el[0];

    if (table.$el[0].zmpDataTable) {
      var instance = table.$el[0].zmpDataTable;
      table.destroy();
      return instance || _assertThisInitialized(_this);
    }

    table.$el[0].zmpDataTable = table;
    ...
    function handleChange(e) {
      if (e.detail && e.detail.sentByZMPDataTable) {
    ...
    function handleSortableClick() {
      var $cellEl = (0, _zmpDom.default)(this);
  ...
  _proto.destroy = function destroy() {
    ...
    if (table.$el[0]) {
      table.$el[0].zmpDataTable = null;
      delete table.$el[0].zmpDataTable;
    }
