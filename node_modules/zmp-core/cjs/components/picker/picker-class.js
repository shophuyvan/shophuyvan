...
var Picker = /*#__PURE__*/function (_ZMPClass) {
  _inheritsLoose(Picker, _ZMPClass);
  ...
  function Picker(app, params) {
    ...
    if (picker.params.containerEl) {
      $containerEl = (0, _zmpDom.default)(picker.params.containerEl);
    ...
    if (picker.params.inputEl) {
      $inputEl = (0, _zmpDom.default)(picker.params.inputEl);
    }

    var $scrollToEl = picker.params.scrollToInput ? $inputEl : undefined;

    if (picker.params.scrollToEl) {
      var scrollToEl = (0, _zmpDom.default)(picker.params.scrollToEl);
    ...
    (0, _utils.extend)(picker, {
      ...
      attachInputEvents: function attachInputEvents() {
        ...
        if (picker.params.inputReadOnly) {
          ...
          if (picker.$inputEl[0]) {
            picker.$inputEl[0].zmpValidateReadonly = true;
          }
        }
      },
      detachInputEvents: function detachInputEvents() {
        ...
        if (picker.params.inputReadOnly) {
          ...
          if (picker.$inputEl[0]) {
            delete picker.$inputEl[0].zmpValidateReadonly;
          }
        }
      },
  ...
  _proto.destroyColumn = function destroyColumn(colEl) {
    var picker = this;
    var $colEl = (0, _zmpDom.default)(colEl);
  ...
  _proto.open = function open() {
    ...
    if (inline) {
      picker.$el = (0, _zmpDom.default)(picker.render());
      picker.$el[0].zmpPicker = picker;
  ...
  _proto.destroy = function destroy() {
    ...
    if ($el && $el.length) delete picker.$el[0].zmpPicker;
