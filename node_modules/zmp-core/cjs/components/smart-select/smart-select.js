...
var _default = {
  ...
  on: {
    tabMounted: function tabMounted(tabEl) {
      var app = this;
      (0, _zmpDom.default)(tabEl).find('.smart-select-init').each(function (smartSelectEl) {
        app.smartSelect.create((0, _utils.extend)({
          el: smartSelectEl
        }, (0, _zmpDom.default)(smartSelectEl).dataset()));
      });
    },
    tabBeforeRemove: function tabBeforeRemove(tabEl) {
      (0, _zmpDom.default)(tabEl).find('.smart-select-init').each(function (smartSelectEl) {
        if (smartSelectEl.zmpSmartSelect && smartSelectEl.zmpSmartSelect.destroy) {
          smartSelectEl.zmpSmartSelect.destroy();
        }
      });
    },
