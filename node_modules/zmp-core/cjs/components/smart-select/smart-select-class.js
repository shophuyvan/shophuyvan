...
var SmartSelect = /*#__PURE__*/function (_ZMPClass) {
  _inheritsLoose(SmartSelect, _ZMPClass);
  ...
  function SmartSelect(app, params) {
    ...
    if (ss.params.setValueText) {
      ...
      if ($valueEl.length === 0) {
        $valueEl = (0, _zmpDom.default)('<div class="item-after"></div>');
      ...
      if (inputEl.type === 'checkbox') {
        for (var i = 0; i < ss.selectEl.options.length; i += 1) {
          ...
          if (optionEl.selected) {
            displayAs = optionEl.dataset ? optionEl.dataset.displayAs : (0, _zmpDom.default)(optionEl).data('display-value-as');
        ...
        displayAs = optionEl.dataset ? optionEl.dataset.displayAs : (0, _zmpDom.default)(optionEl).data('display-as');
        text = displayAs && typeof displayAs !== 'undefined' ? displayAs : optionEl.textContent;
        optionText = [text];
  ...
  _proto.checkMaxLength = function checkMaxLength() {
    ...
    if (ss.selectEl.selectedOptions.length >= ss.maxLength) {
      $containerEl.find('input[type="checkbox"]').each(function (inputEl) {
        if (!inputEl.checked) {
          (0, _zmpDom.default)(inputEl).parents('li').addClass('disabled');
        } else {
          (0, _zmpDom.default)(inputEl).parents('li').removeClass('disabled');
        }
      });
    } else {
  ...
  _proto.setValueText = function setValueText(value) {
    ...
    if (typeof value !== 'undefined') {
      ...
      ss.$selectEl.find('option').each(function (optionEl) {
        var $optionEl = (0, _zmpDom.default)(optionEl);
  ...
  _proto.renderItem = function renderItem(item, index) {
    ...
    function getIconClass(iconValue) {
      ...
      if (iconValue.indexOf(':') >= 0) {
        ...
        if (className === 'zmp') className = 'zmp-icons';
  ...
  _proto.onOpen = function onOpen(type, containerEl) {
    var ss = this;
    var app = ss.app;
    var $containerEl = (0, _zmpDom.default)(containerEl);
    ...
    if (ss.params.searchbar) {
      ...
      if (type === 'page' && app.theme === 'ios') {
        $searchbarEl = (0, _zmpDom.default)(app.navbar.getElByPage($containerEl)).find('.searchbar');
      }
      ...
      if (ss.params.appendSearchbarNotFound && (type === 'page' || type === 'popup')) {
        ...
        if (typeof ss.params.appendSearchbarNotFound === 'string') {
          $notFoundEl = (0, _zmpDom.default)("<div class=\"block searchbar-not-found\">" + ss.params.appendSearchbarNotFound + "</div>");
        } else if (typeof ss.params.appendSearchbarNotFound === 'boolean') {
          $notFoundEl = (0, _zmpDom.default)('<div class="block searchbar-not-found">Nothing found</div>');
        } else {
  ...
  _createClass(SmartSelect, [{
    ...
    get: function get() {
      ...
      if (!view) {
        view = $el.parents('.view').length && $el.parents('.view')[0].zmpView;
      }
