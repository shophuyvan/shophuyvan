...
var Navbar = {
  ...
  hide: function hide(el, animate, hideStatusbar, hideOnlyCurrent) {
    ...
    if (isDynamic) {
      $el.children('.navbar').each(function (subEl) {
        (0, _zmpDom.default)(subEl).trigger('navbar:hide');
  ...
  show: function show(el, animate, hideOnlyCurrent) {
    ...
    if (isDynamic) {
      $el.children('.navbar').each(function (subEl) {
        (0, _zmpDom.default)(subEl).trigger('navbar:show');
  ...
  collapseLargeTitle: function collapseLargeTitle(navbarEl) {
    ...
    if ($navbarEl.hasClass('navbars')) {
      ...
      if ($navbarEl.length > 1) {
        $navbarEl = (0, _zmpDom.default)(navbarEl).find('.navbar-large.navbar-current');
      }
    ...
    var $pageEl = (0, _zmpDom.default)(app.navbar.getPageByEl($navbarEl));
  ...
  initNavbarOnScroll: function initNavbarOnScroll(pageEl, navbarEl, needHide, needCollapse, needTransparent) {
    ...
    function snapLargeNavbar() {
      ...
      if (currentScrollTop >= navbarTitleLargeHeight / 2 && currentScrollTop < navbarTitleLargeHeight) {
        (0, _zmpDom.default)(scrollContent).scrollTop(navbarTitleLargeHeight, 100);
      } else if (currentScrollTop < navbarTitleLargeHeight) {
        (0, _zmpDom.default)(scrollContent).scrollTop(0, 200);
      }
    }
    ...
    function snapTransparentNavbar() {
      ...
      if (currentScrollTop >= navbarOffsetHeight / 2 && currentScrollTop < navbarOffsetHeight) {
        (0, _zmpDom.default)(scrollContent).scrollTop(navbarOffsetHeight, 100);
...
var _default = {
  ...
  on: {
    'panelBreakpoint panelCollapsedBreakpoint panelResize viewResize resize viewMasterDetailBreakpoint': function onPanelResize() {
      var app = this;
      (0, _zmpDom.default)('.navbar').each(function (navbarEl) {
        app.navbar.size(navbarEl);
      });
    },
    ...
    pageBeforeIn: function pageBeforeIn(page) {
      ...
      if (!navbarEl) {
        ...
        $navbarsEl = (0, _zmpDom.default)(navbarEl).parents('.navbars');
      }
    ...
    pageReinit: function pageReinit(page) {
      var app = this;
      var $navbarEl = (0, _zmpDom.default)(app.navbar.getElByPage(page));
    ...
    tabShow: function tabShow(tabEl) {
      var app = this;
      (0, _zmpDom.default)(tabEl).find('.navbar:not(.navbar-previous):not(.stacked)').each(function (navbarEl) {
        app.navbar.size(navbarEl);
      });
    }
  },
