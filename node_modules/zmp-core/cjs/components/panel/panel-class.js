...
var Panel = /*#__PURE__*/function (_ZMPClass) {
  _inheritsLoose(Panel, _ZMPClass);
  ...
  function Panel(app, params) {
    ...
    _this = _ZMPClass.call(this, extendedParams, [app]) || this;

    var panel = _assertThisInitialized(_this);

    panel.params = extendedParams;
    panel.$containerEl = panel.params.containerEl ? (0, _zmpDom.default)(panel.params.containerEl).eq(0) : app.$el;
    ...
    if (panel.params.el) {
      $el = (0, _zmpDom.default)(panel.params.el).eq(0);
    } else if (panel.params.content) {
      $el = (0, _zmpDom.default)(panel.params.content).filter(function (node) {
        return node.nodeType === 1;
      }).eq(0);
    }

    if ($el.length === 0) return panel || _assertThisInitialized(_this);
    if ($el[0].zmpPanel) return $el[0].zmpPanel || _assertThisInitialized(_this);
    $el[0].zmpPanel = panel;
    ...
    if (panel.params.backdrop && panel.params.backdropEl) {
      $backdropEl = (0, _zmpDom.default)(panel.params.backdropEl);
    } else if (panel.params.backdrop) {
      $backdropEl = panel.$containerEl.children('.panel-backdrop');

      if ($backdropEl.length === 0) {
        $backdropEl = (0, _zmpDom.default)('<div class="panel-backdrop"></div>');
  ...
  _proto.setStateClasses = function setStateClasses(state) {
    ...
    var $targetEl = !viewEl || panelInView ? panel.$containerEl : (0, _zmpDom.default)('html');
  ...
  _proto.setVisibleBreakpoint = function setVisibleBreakpoint(emitEvents) {
    ...
    var $viewEl = (0, _zmpDom.default)(panel.getViewEl());
  ...
  _proto.open = function open(animate) {
    ...
    function panelTransitionEnd() {
      transitionEndTarget.transitionEnd(function (e) {
        if ((0, _zmpDom.default)(e.target).is(transitionEndTarget)) {
  ...
  _proto.destroy = function destroy() {
    ...
    if (panel.el) {
      panel.el.zmpPanel = null;
      delete panel.el.zmpPanel;
    }
