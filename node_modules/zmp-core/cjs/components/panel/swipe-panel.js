...
function swipePanel(panel) {
  ...
  function handleTouchStart(e) {
    ...
    if ((0, _zmpDom.default)('.modal-in:not(.toast):not(.notification), .photo-browser-in').length > 0) return;
    ...
    if ((0, _zmpDom.default)(e.target).closest('.range-slider, .tabs-swipeable-wrap, .calendar-months, .no-swipe-panel, .card-opened').length > 0) return;
    ...
    touchMoves = 0;
    $viewEl = (0, _zmpDom.default)(panel.getViewEl());
    isMoved = false;
    isTouched = true;
  ...
  function handleTouchMove(e) {
    ...
    if (e.zmpPreventSwipePanel || app.preventSwipePanelBySwipeBack || app.preventSwipePanel) {
      isTouched = false;
      return;
    }
