...
var _default = {
  ...
  on: {
    init: function init() {
      var app = this;
      (0, _zmpDom.default)('.panel-init').each(function (panelEl) {
        var params = Object.assign({
          el: panelEl
        }, (0, _zmpDom.default)(panelEl).dataset() || {});
  ...
  clicks: {
    ...
    '.panel-backdrop': function close() {
      var app = this;
      var $panelEl = (0, _zmpDom.default)('.panel-in:not(.panel-out)');
      if (!$panelEl.length) return;
      var instance = $panelEl[0] && $panelEl[0].zmpPanel;
