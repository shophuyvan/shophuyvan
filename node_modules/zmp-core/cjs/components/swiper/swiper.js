...
function initSwiper(swiperEl) {
  var app = this;
  var $swiperEl = (0, _zmpDom.default)(swiperEl);
  ...
  } else if ($swiperEl[0].zmpSwiperParams) {
    params = $swiperEl[0].zmpSwiperParams;
  } else {
...
var _default = {
  ...
  on: {
    ...
    tabMounted: function tabMounted(tabEl) {
      var app = this;
      (0, _zmpDom.default)(tabEl).find('.swiper-init, .tabs-swipeable-wrap').each(function (swiperEl) {
        initSwiper.call(app, swiperEl);
      });
    },
