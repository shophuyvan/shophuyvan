...
var Messages = /*#__PURE__*/function (_ZMPClass) {
  _inheritsLoose(Messages, _ZMPClass);
  ...
  function Messages(app, params) {
    ...
    var $el = (0, _zmpDom.default)(params.el).eq(0);
    if ($el.length === 0) return m || _assertThisInitialized(_this);
    if ($el[0].zmpMessages) return $el[0].zmpMessages || _assertThisInitialized(_this);
    $el[0].zmpMessages = m;
  ...
  _proto.getMessageData = function getMessageData(messageEl) {
    var $messageEl = (0, _zmpDom.default)(messageEl);
    var data = {
  ...
  _proto.removeMessage = function removeMessage(messageToRemove, layout) {
    ...
    if (typeof messageToRemove === 'number') {
      ...
      $el = (0, _zmpDom.default)(messageToRemove);
      index = $el.index();
    }
  ...
  _proto.removeMessages = function removeMessages(messagesToRemove, layout) {
    ...
    if (Array.isArray(messagesToRemove)) {
      ...
      (0, _zmpDom.default)(messagesToRemove).each(function (messageToRemove) {
        m.removeMessage(messageToRemove, false);
      });
    }
  ...
  _proto.addMessages = function addMessages() {
    ...
    var $messagesEls = (0, _zmpDom.default)(messagesHTML);
  ...
  _proto.destroy = function destroy() {
    ...
    if (m.$el[0]) {
      m.$el[0].zmpMessages = null;
      delete m.$el[0].zmpMessages;
    }
