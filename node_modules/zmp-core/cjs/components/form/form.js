...
var FormData = {
  store: function store(form, data) {
    ...
    var formId = form;
    var $formEl = (0, _zmpDom.default)(form);
    ...
    if (this.isLocalStorageAvailable) {
      window.localStorage["zmpform-" + formId] = JSON.stringify(data);
    }
  },
  get: function get(form) {
    ...
    if (this.isLocalStorageAvailable && window.localStorage["zmpform-" + formId]) {
      return JSON.parse(window.localStorage["zmpform-" + formId]);
    }
  ...
  remove: function remove(form) {
    ...
    if (this.isLocalStorageAvailable && window.localStorage["zmpform-" + formId]) {
      window.localStorage["zmpform-" + formId] = '';
      window.localStorage.removeItem("zmpform-" + formId);
    }
  }
}; // Form Storage
...
var FormStorage = {
  init: function init(formEl) {
    var app = this;
    var $formEl = (0, _zmpDom.default)(formEl);
...
function formToData(formEl) {
  var app = this;
  var $formEl = (0, _zmpDom.default)(formEl).eq(0);
...
function initAjaxForm() {
  ...
  function onSubmitChange(e, fromData) {
    var $formEl = (0, _zmpDom.default)(this);
  ...
  (0, _zmpDom.default)(document).on('submit change', 'form.form-ajax-submit, form.form-ajax-submit-onchange', onSubmitChange);
}
...
var _default = {
  ...
  create: function create() {
    this.isLocalStorageAvailable = (0, _utils.checkLocalStorage)();
    var app = this;
    (0, _utils.extend)(app, {
      form: {
        data: {},
  ...
  on: {
    ...
    tabBeforeRemove: function tabBeforeRemove(tabEl) {
      var app = this;
      (0, _zmpDom.default)(tabEl).find('.form-store-data').each(function (formEl) {
