...
var Notification = /*#__PURE__*/function (_Modal) {
  ...
  function Notification(app, params) {
    ...
    if (!notification.params.el) {
      ...
      $el = (0, _zmpDom.default)(notificationHtml);
    } else {
      $el = (0, _zmpDom.default)(notification.params.el);
    }
    ...
    $el.on('click', function (e) {
      if (closeButton && (0, _zmpDom.default)(e.target).closest('.notification-close-button').length) {
        return;
      }
    ...
    notification.on('open', function () {
      ...
      (0, _zmpDom.default)('.notification.modal-in').each(function (openedEl) {
