...
var Dialog = /*#__PURE__*/function (_Modal) {
  ...
  function Dialog(app, params) {
    ...
    if (!dialog.params.el) {
      ...
      $el = (0, _zmpDom.default)(dialogHtml);
    } else {
      $el = (0, _zmpDom.default)(dialog.params.el);
    }
    ...
    if (backdrop) {
      ...
      if ($backdropEl.length === 0) {
        $backdropEl = (0, _zmpDom.default)('<div class="dialog-backdrop"></div>');
    ...
    function buttonOnClick(e) {
      var buttonEl = this;
      var index = (0, _zmpDom.default)(buttonEl).index();
    ...
    if (buttons && buttons.length > 0) {
      dialog.on('open', function () {
        ...
        if (addKeyboardHander && !device.ios && !device.android) {
    ...
    (0, _utils.extend)(dialog, {
      ...
      setText: function setText(newText) {
        ...
        if ($textEl.length === 0) {
          $textEl = (0, _zmpDom.default)('<div class="dialog-text"></div>');
      ...
      setTitle: function setTitle(newTitle) {
        ...
        if ($titleEl.length === 0) {
          $titleEl = (0, _zmpDom.default)('<div class="dialog-title"></div>');
