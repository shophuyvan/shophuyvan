...
(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.ZMP = factory());
     ...
     * https://h5.zalo.me/zmp/docs/zmp-dom.html
     *
    ...
    function data(key, value) {
      ...
      if (typeof value === 'undefined') {
        ...
        if (el.zmpDOMElementDataStorage && key in el.zmpDOMElementDataStorage) {
          return el.zmpDOMElementDataStorage[key];
        }
      ...
      for (var i = 0; i < this.length; i += 1) {
        el = this[i];
        if (!el.zmpDOMElementDataStorage) el.zmpDOMElementDataStorage = {};
        el.zmpDOMElementDataStorage[key] = value;
      }
    ...
    function removeData(key) {
      for (var i = 0; i < this.length; i += 1) {
        ...
        if (el.zmpDOMElementDataStorage && el.zmpDOMElementDataStorage[key]) {
          el.zmpDOMElementDataStorage[key] = null;
          delete el.zmpDOMElementDataStorage[key];
        }
      }
    }
    ...
    function on() {
      ...
      function handleLiveEvent(e) {
        var target = e.target;
        if (!target) return;
        var eventData = e.target.zmpDOMEventData || [];
      ...
      function handleEvent(e) {
        var eventData = e && e.target ? e.target.zmpDOMEventData || [] : [];
      ...
      for (var i = 0; i < this.length; i += 1) {
        ...
        if (!targetSelector) {
          for (j = 0; j < events.length; j += 1) {
            var event = events[j];
            if (!el.zmpDOMListeners) el.zmpDOMListeners = {};
            if (!el.zmpDOMListeners[event]) el.zmpDOMListeners[event] = [];
            el.zmpDOMListeners[event].push({
              listener: listener,
          ...
          for (j = 0; j < events.length; j += 1) {
            var _event = events[j];
            if (!el.zmpDOMLiveListeners) el.zmpDOMLiveListeners = {};
            if (!el.zmpDOMLiveListeners[_event]) el.zmpDOMLiveListeners[_event] = [];

            el.zmpDOMLiveListeners[_event].push({
              listener: listener,
    ...
    function off() {
      ...
      for (var i = 0; i < events.length; i += 1) {
        ...
        for (var j = 0; j < this.length; j += 1) {
          ...
          if (!targetSelector && el.zmpDOMListeners) {
            handlers = el.zmpDOMListeners[event];
          } else if (targetSelector && el.zmpDOMLiveListeners) {
            handlers = el.zmpDOMLiveListeners[event];
          }
          ...
          if (handlers && handlers.length) {
            for (var k = handlers.length - 1; k >= 0; k -= 1) {
              ...
              if (listener && handler.listener === listener) {
                ...
                handlers.splice(k, 1);
              } else if (listener && handler.listener && handler.listener.zmpDOMproxy && handler.listener.zmpDOMproxy === listener) {
                el.removeEventListener(event, handler.proxyListener, capture);
                handlers.splice(k, 1);
              } else if (!listener) {
                el.removeEventListener(event, handler.proxyListener, capture);
    ...
    function once() {
      ...
      function onceHandler() {
        ...
        if (onceHandler.zmpDOMproxy) {
          delete onceHandler.zmpDOMproxy;
        }
      }

      onceHandler.zmpDOMproxy = listener;
      ...
      for (var i = 0; i < events.length; i += 1) {
        ...
        for (var j = 0; j < this.length; j += 1) {
          ...
          if (window.CustomEvent) {
            ...
            el.zmpDOMEventData = args.filter(function (data, dataIndex) {
              return dataIndex > 0;
            });
            el.dispatchEvent(evt);
            el.zmpDOMEventData = [];
            delete el.zmpDOMEventData;
          }
        }
      }
    ...
    function animate(initialProps, initialParams) {
      ...
      var a = {
        ...
        stop: function stop() {
          ...
          a.elements.each(function (el) {
            var element = el;
            delete element.zmpDOMAnimateInstance;
          });
          a.que = [];
        },
        ...
        animate: function animate(props, params) {
          ...
          a.elements.each(function (el, index) {
            ...
            var finalValue;
            var finalFullValue;
            if (!el.zmpDOMAnimateInstance) a.elements[index].zmpDOMAnimateInstance = a;
            elements[index] = {
              container: el
            };
      ...
      for (var i = 0; i < a.elements.length; i += 1) {
        if (a.elements[i].zmpDOMAnimateInstance) {
          animateInstance = a.elements[i].zmpDOMAnimateInstance;
        } else a.elements[i].zmpDOMAnimateInstance = a;
      }
    ...
    function stop() {
      ...
      for (var i = 0; i < els.length; i += 1) {
        if (els[i].zmpDOMAnimateInstance) {
          els[i].zmpDOMAnimateInstance.stop();
        }
      }
    }
    ...
    var EventsClass = /*#__PURE__*/function () {
      ...
      _proto.once = function once(events, handler, priority) {
        ...
        function onceHandler() {
          ...
          if (onceHandler.zmpproxy) {
            delete onceHandler.zmpproxy;
          }
        ...
        events.split(' ').forEach(function (event) {
          if (typeof handler === 'undefined') {
            ...
            self.eventsListeners[event].forEach(function (eventHandler, index) {
              if (eventHandler === handler || eventHandler.zmpproxy && eventHandler.zmpproxy === handler) {
    ...
    var ZMPClass = /*#__PURE__*/function (_EventsClass) {
      _inheritsLoose(ZMPClass, _EventsClass);

      function ZMPClass(params, parents) {
        var _this;
      ...
      ZMPClass.installModule = function installModule(module) {
        var Class = this;
      ...
      ZMPClass.use = function use(module) {
        var Class = this;
    ...
    var ZMP = /*#__PURE__*/function (_ZMPClass) {
      _inheritsLoose(ZMP, _ZMPClass);
      ...
      function ZMP(params) {
        ...
        _this = _ZMPClass.call(this, params) || this; // eslint-disable-next-line

        if (ZMP.instance && typeof window !== 'undefined') {
          throw new Error("ZMP is already initialized and can't be initialized more than once");
        }
        ...
        app.device = device;
        app.support = support;
        var w = getWindow(); // const d = getDocument();

        ZMP.instance = app; // Default
      ...
      _proto.initAppComponent = function initAppComponent(callback) {
        ...
        app.router.componentLoader(app.params.component, app.params.componentUrl, {
          ...
          app.$el = $(el);
          app.$el[0].zmp = app;
          app.$elComponent = el.zmpComponent;
          app.el = app.$el[0];
          if (callback) callback();
        }, function () {});
      };
      ...
      _proto.init = function init(rootEl) {
        ...
        var init = function init() {
          ...
          app.$el.addClass('zmp-initializing'); // RTL attr
          ...
          app.$el.addClass('zmp-root'); // Theme class
          ...
          nextFrame$1(function () {
            app.$el.removeClass('zmp-initializing');
      ...
      _proto.loadModule = function loadModule() {
        return ZMP.loadModule.apply(ZMP, arguments);
      } // eslint-disable-next-line
      ;

      _proto.loadModules = function loadModules() {
        return ZMP.loadModules.apply(ZMP, arguments);
      };
    ...
    ZMP.ModalMethods = ModalMethods;
    ZMP.ConstructorMethods = ConstructorMethods;
    ZMP.loadModule = loadModule;

    ZMP.loadModules = function loadModules(modules) {
      return Promise.all(modules.map(function (module) {
        return ZMP.loadModule(module);
      }));
    };
    ...
    var request = function request(requestOptions) {
      return new Promise(function (resolve, reject) {
        ...
        if (options.dataType === 'json' && options.url.indexOf('callback=') >= 0) {
          var callbackName = "zmpjsonp_" + (Date.now() + (jsonpRequests += 1));
          var abortTimeout;
    ...
    function initTouch() {
      ...
      function handleClick(e) {
        var isOverswipe = e && e.detail && e.detail === 'zmpOverswipe';
    ...
    function SwipeBack(r) {
      ...
      var transformOriginTitleLarge = app.rtl ? 'calc(100% - var(--zmp-navbar-large-title-padding-left) - var(--zmp-safe-area-left)) center' : 'calc(var(--zmp-navbar-large-title-padding-left) + var(--zmp-safe-area-left)) center';
      ...
      function animatableNavElements() {
        ...
        if (params.iosAnimateNavbarBackIcon) {
          ...
          if (activeNavBackIconText.length) {
            $previousNavElements.each(function (el) {
              ...
              el.zmpNavbarLeftOffset += activeNavBackIconText.prev('.icon')[0].offsetWidth;
            });
          }
        }
        ...
        $currentNavElements.each(function (navEl) {
            ...
            if (isLeft) {
              ...
              $navEl.find('.back span').each(function (subNavEl) {
                els.push({
                  ...
                  transform: function transform(progress) {
                    return "translateX(calc(" + progress + " * (var(--zmp-navbarTitleLargeOffset) - var(--zmp-navbarLeftTextOffset)))) translateY(calc(" + progress + " * (var(--zmp-navbar-large-title-height) - var(--zmp-navbar-large-title-padding-vertical) / 2))) scale(" + (1 + 1 * progress) + ")";
                  }
                });
              });
              return;
          ...
          if (isBg) {
            ...
            if (!fromLarge && !toLarge) {
              if (currentNavIsCollapsed) {
                ...
                el.transform = function (progress) {
                  return "translateX(" + 100 * progress * inverter + "%) translateY(calc(-1 * var(--zmp-navbar-large-title-height)))";
                };
              } else {
                el.transform = function (progress) {
            ...
            if (!fromLarge && toLarge) {
              ...
              el.transform = function (progress) {
                return "translateX(" + 100 * progress * inverter + "%) translateY(calc(-1 * " + (1 - progress) + " * var(--zmp-navbar-large-title-height)))";
              };
            }
            ...
            if (fromLarge && !toLarge) {
              el.transform = function (progress) {
                return "translateX(" + 100 * progress * inverter + "%) translateY(calc(-" + progress + " * var(--zmp-navbar-large-title-height)))";
              };
            }
          ...
          if (isSliding) {
            ...
            transformTarget.transform = function (progress) {
              var activeNavTranslate = progress * transformTarget.el.zmpNavbarRightOffset;
              if (device.pixelRatio === 1) activeNavTranslate = Math.round(activeNavTranslate);

              if (isSubnavbar && currentNavIsLarge) {
                return "translate3d(" + activeNavTranslate + "px, calc(-1 * var(--zmp-navbar-large-collapse-progress) * var(--zmp-navbar-large-title-height)), 0)";
              }
        ...
        $previousNavElements.each(function (navEl) {
            ...
            if ($navEl.hasClass('title-large')) {
              ...
              $navEl.find('.title-large-text').each(function (subNavEl) {
                els.push({
                  ...
                  transform: function transform(progress) {
                    return "translateX(calc(" + (1 - progress) + " * (var(--zmp-navbarLeftTextOffset) - var(--zmp-navbarTitleLargeOffset)))) translateY(calc(" + (progress - 1) + " * var(--zmp-navbar-large-title-height) + " + (1 - progress) + " * var(--zmp-navbar-large-title-padding-vertical))) scale(" + (0.5 + progress * 0.5) + ")";
                  }
                });
              });
              return;
          ...
          if (isBg) {
            ...
            if (!fromLarge && !toLarge) {
              if (previousNavIsCollapsed) {
                ...
                el.transform = function (progress) {
                  return "translateX(" + (-100 + 100 * progress) * inverter + "%) translateY(calc(-1 * var(--zmp-navbar-large-title-height)))";
                };
              } else {
                el.transform = function (progress) {
            ...
            if (!fromLarge && toLarge) {
              el.transform = function (progress) {
                return "translateX(" + (-100 + 100 * progress) * inverter + "%) translateY(calc(-1 * " + (1 - progress) + " * var(--zmp-navbar-large-title-height)))";
              };
            }
            ...
            if (fromLarge && !toLarge) {
              ...
              el.transform = function (progress) {
                return "translateX(" + (-100 + 100 * progress) * inverter + "%) translateY(calc(-" + progress + " * var(--zmp-navbar-large-title-height)))";
              };
            }
          ...
          if (isSliding) {
            ...
            transformTarget.transform = function (progress) {
              var previousNavTranslate = transformTarget.el.zmpNavbarLeftOffset * (1 - progress);
              if (device.pixelRatio === 1) previousNavTranslate = Math.round(previousNavTranslate);

              if (isSubnavbar && previousNavIsLarge) {
                return "translate3d(" + previousNavTranslate + "px, calc(-1 * var(--zmp-navbar-large-collapse-progress) * var(--zmp-navbar-large-title-height)), 0)";
              }
      ...
      function handleTouchMove(e) {
        ...
        if (isScrolling || e.zmpPreventSwipeBack || app.preventSwipeBack) {
          isTouched = false;
          return;
        }
      ...
      function handleTouchEnd(e) {
        ...
        if (pageChanged) {
          // Update Route
          router.currentRoute = $previousPageEl[0].zmpPage.route;
    ...
    function appRouterCheck(router, method) {
      if (!router.view) {
        throw new Error("ZMP: it is not allowed to use router methods on global app router. Use router methods only on related View, e.g. app.views.main.router." + method + "(...)");
      }
    }
    ...
    function forward(router, el, forwardOptions) {
      ...
      if (dynamicNavbar) {
        ...
        if ($newNavbarEl.length === 0 && $newPage[0] && $newPage[0].zmpPage) {
          // Try from pageData
          $newNavbarEl = $newPage[0].zmpPage.$navbarEl;
        }
      ...
      var zmpComponent = $newPage[0].zmpComponent;

      if (options.reloadPrevious) {
        if (zmpComponent && !newPageInDom) {
          zmpComponent.mount(function (componentEl) {
      ...
      } else if (options.route && options.route.route && options.route.route.keepAlive && !$newPage[0].zmpPageMounted) {
        $newPage[0].zmpPageMounted = true;
        router.pageCallback('mounted', $newPage, $newNavbarEl, newPagePosition, reload ? newPagePosition : 'current', options, $oldPage);
      } // Remove old page
      ...
      if (options.reloadCurrent || options.reloadAll || reloadDetail) {
        ...
        if (reloadDetail) {
          ...
          if (masterPageEl.zmpPage && masterPageEl.zmpPage.navbarEl) {
            router.setNavbarPosition($(masterPageEl.zmpPage.navbarEl), 'previous');
          }
        }
      ...
      if (options.animate && !(isMaster && app.width >= router.params.masterDetailBreakpoint)) {
        ...
        if (transition) {
          $newPage[0].zmpPageTransition = transition;
        }
    ...
    function load(router, loadParams, loadOptions, ignorePageChange) {
      ...
      if (content) {
        ...
        // Load from component (ZMP/Vue/React/...)
        try {
    ...
    function navigate(navigateParams, navigateOptions) {
      ...
      if (route.route && route.route.viewName) {
        ...
        if (!anotherView) {
          throw new Error("ZMP: There is no View with \"" + anotherViewName + "\" name that was specified in this route");
        }
    ...
    function tabLoad(tabRoute, loadOptions) {
      ...
      if ($newTabEl && $newTabEl.parents('.page').length > 0 && options.route) {
        var tabParentPageData = $newTabEl.parents('.page')[0].zmpPage;
      ...
      if ($newTabEl[0].zmpRouterTabLoaded) {
      ...
      function loadTab(loadTabParams, loadTabOptions) {
        ...
        function resolve(contentEl) {
          ...
          if (typeof contentEl === 'string') {
            ...
            if (contentEl.zmpComponent) {
              contentEl.zmpComponent.mount(function (componentEl) {
          ...
          $newTabEl[0].zmpRouterTabLoaded = true;
    ...
    function tabRemove($oldTabEl, $newTabEl, tabRoute) {
      ...
      if ($oldTabEl[0]) {
        $oldTabEl[0].zmpRouterTabLoaded = false;
        delete $oldTabEl[0].zmpRouterTabLoaded;
      }

      $oldTabEl.children().each(function (tabChild) {
        if (tabChild.zmpComponent) {
          hasTabComponentChild = true;
          $(tabChild).trigger('tab:beforeremove', tabRoute);
          tabChild.zmpComponent.destroy();
        }
      });
    ...
    function modalLoad(modalType, route, loadOptions, direction) {
      ...
      function onModalLoaded() {
        ...
        modal.on(modalOrPanel + "Closed", function () {
          ...
          var modalComponent = modal.el.zmpComponent;
      ...
      function loadModal(loadModalParams, loadModalOptions) {
        ...
        function resolve(contentEl) {
          if (contentEl) {
            ...
            } else if (contentEl.zmpComponent) {
              contentEl.zmpComponent.mount(function (componentEl) {
    ...
    function backward(router, el, backwardOptions) {
      ...
      if (router.disableAnimation) {
        options.animate = false;
      }

      router.disableAnimation = false;
      var masterDetailEnabled = router.params.masterDetailBreakpoint > 0;
      var isMaster = masterDetailEnabled && options.route && options.route.route && (options.route.route.master === true || typeof options.route.route.master === 'function' && options.route.route.master(app, router));
      var masterPageEl;
      ...
      if (masterDetailEnabled) {
        ...
        isDetail = !isMaster && masterPageEl && router.history.indexOf(options.route.url) > router.history.indexOf(masterPageEl.zmpPage.route.url);

        if (!isDetail && !isMaster && masterPageEl && masterPageEl.zmpPage && options.route.route.masterRoute) {
          isDetail = options.route.route.masterRoute.path === masterPageEl.zmpPage.route.route.path;
        }
      }

      if (isDetail && masterPageEl && masterPageEl.zmpPage) {
        isDetailRoot = router.history.indexOf(options.route.url) - router.history.indexOf(masterPageEl.zmpPage.route.url) === 1;
      } // New Page
      ...
      if (options.animate && !(currentIsMaster && app.width >= router.params.masterDetailBreakpoint)) {
        ...
        if ($oldPage[0] && $oldPage[0].zmpPageTransition) {
          transition = $oldPage[0].zmpPageTransition;
          delete $oldPage[0].zmpPageTransition;
        }
    ...
    function back() {
      ...
      if (router.params.masterDetailBreakpoint > 0) {
        ...
        if ($previousMaster.length) {
          ...
          if (expectedPreviousPageRoute && $previousMaster[0].zmpPage && expectedPreviousPageRoute.route === $previousMaster[0].zmpPage.route.route) {
      ...
      if (!navigateOptions.force && $previousPage.length && !skipMaster) {
        if (router.params.browserHistory && $previousPage[0].zmpPage && router.history[router.history.length - 2] !== $previousPage[0].zmpPage.route.url) {
        ...
        var previousPageRoute = $previousPage[0].zmpPage.route;
      ...
      if (options.force && router.params.stackPages) {
        router.$el.children('.page-previous.stacked').each(function (pageEl) {
          if (pageEl.zmpPage && pageEl.zmpPage.route && pageEl.zmpPage.route.url === route.url) {
    ...
    var Router = /*#__PURE__*/function (_ZMPClass) {
      _inheritsLoose(Router, _ZMPClass);

      function Router(app, view) {
        var _this;

        _this = _ZMPClass.call(this, {}, [typeof view === 'undefined' ? app : view]) || this;
        ...
        router.allowPageChange = true; // Mini App route config

        var window = getWindow();
        router.miniAppRouteConfig = !!(window.APP_CONFIG && window.APP_CONFIG.pages); // Current Route
      ...
      _proto.animatableNavElements = function animatableNavElements($newNavbarEl, $oldNavbarEl, toLarge, fromLarge, direction) {
        ...
        function animatableNavEl($el, $navbarInner) {
          ...
          return {
            ...
            leftOffset: $el[0].zmpNavbarLeftOffset,
            rightOffset: $el[0].zmpNavbarRightOffset,
            isSliding: isSliding,
          ...
          newNavEls.forEach(function (navEl) {
            ...
            if (navEl.isSliding) {
              if (navEl.isSubnavbar && newIsLarge) {
                // prettier-ignore
                $el[0].style.setProperty('transform', "translate3d(" + offset * (1 - progress) + "px, calc(-1 * var(--zmp-navbar-large-collapse-progress) * var(--zmp-navbar-large-title-height)), 0)", 'important');
              } else {
          ...
          oldNavEls.forEach(function (navEl) {
            ...
            if (navEl.isSliding) {
              if (navEl.isSubnavbar && oldIsLarge) {
                $el.transform("translate3d(" + offset * progress + "px, calc(-1 * var(--zmp-navbar-large-collapse-progress) * var(--zmp-navbar-large-title-height)), 0)");
              } else {
      ...
      _proto.removePage = function removePage(el) {
        var $el = $(el);
        var zmpPage = $el && $el[0] && $el[0].zmpPage;
        var router = this;
      ...
      _proto.removeEl = function removeEl(el) {
        ...
        if ($el[0].zmpComponent && $el[0].zmpComponent.destroy) {
          $el[0].zmpComponent.destroy();
        }
      ...
      _proto.generateUrl = function generateUrl(parameters) {
        ...
        if (!name && !path) {
          throw new Error('ZMP: "name" or "path" parameter is required');
        }

        var router = this;
        var miniAppRouteConfig = router.miniAppRouteConfig;
        var route = name ? router.findRouteByKey('name', name) : router.findRouteByKey('path', path);

        if (!route && miniAppRouteConfig && typeof path === 'string' && path.charAt(path.length - 1) !== '/') {
          var routeSearchByAlias = router.findRouteByKey('alias', path);
          var matchedRoutePath = routeSearchByAlias ? routeSearchByAlias.path : undefined;

          if (matchedRoutePath && matchedRoutePath.substring(0, matchedRoutePath.length - 1) === path) {
            route = routeSearchByAlias;
          }
        }

        if (!route) {
          if (name) {
            throw new Error("ZMP: route with name \"" + name + "\" not found");
          } else {
            throw new Error("ZMP: route with path \"" + path + "\" not found");
          }
        }
        ...
        if (!url) {
          throw new Error("ZMP: can't construct URL for route with name \"" + name + "\"");
        }
      ...
      _proto.constructRouteUrl = function constructRouteUrl(route, _temp) {
        ...
        try {
          ...
          throw new Error("ZMP: error constructing route URL from passed params:\nRoute: " + path + "\n" + error.toString());
        }
      ...
      _proto.getPageData = function getPageData(pageEl, navbarEl, from, to, route, pageFromEl) {
        ...
        var currentPage = $pageEl[0].zmpPage || {};
        var direction;
        var pageFrom;
      ...
      _proto.pageCallback = function pageCallback(callback, pageEl, navbarEl, from, to, options, pageFromEl) {
        ...
        var keepAlive = $pageEl[0].zmpPage && $pageEl[0].zmpPage.route && $pageEl[0].zmpPage.route.route && $pageEl[0].zmpPage.route.route.keepAlive;
        ...
        if (callback === 'beforeRemove' && $pageEl[0].zmpPage) {
          page = extend($pageEl[0].zmpPage, {
            from: from,
            to: to,
            position: from
          });
        ...
        function attachEvents() {
          if ($pageEl[0].zmpRouteEventsAttached) return;
          $pageEl[0].zmpRouteEventsAttached = true;

          if (on && Object.keys(on).length > 0) {
            $pageEl[0].zmpRouteEventsOn = on;
          ...
          if (once && Object.keys(once).length > 0) {
            $pageEl[0].zmpRouteEventsOnce = once;
        ...
        function detachEvents() {
          ...
          if ($pageEl[0].zmpRouteEventsOn) {
            Object.keys($pageEl[0].zmpRouteEventsOn).forEach(function (eventName) {
              $pageEl.off(eventNameToColonCase(eventName), $pageEl[0].zmpRouteEventsOn[eventName]);
            });
          }

          if ($pageEl[0].zmpRouteEventsOnce) {
            Object.keys($pageEl[0].zmpRouteEventsOnce).forEach(function (eventName) {
              $pageEl.off(eventNameToColonCase(eventName), $pageEl[0].zmpRouteEventsOnce[eventName]);
            });
          }

          $pageEl[0].zmpRouteEventsAttached = null;
          $pageEl[0].zmpRouteEventsOn = null;
          $pageEl[0].zmpRouteEventsOnce = null;
          delete $pageEl[0].zmpRouteEventsAttached;
          delete $pageEl[0].zmpRouteEventsOn;
          delete $pageEl[0].zmpRouteEventsOnce;
        }
        ...
        if (callback === 'init') {
          ...
          if ($pageEl[0].zmpPageInitialized) {
            $pageEl.trigger('page:reinit', page);
            router.emit('pageReinit', page);
            return;
          }

          $pageEl[0].zmpPageInitialized = true;
        }
        ...
        if (callback === 'beforeRemove' || callback === 'beforeUnmount') {
          ...
          if (!keepAlive) {
            if ($pageEl[0].zmpPage && $pageEl[0].zmpPage.navbarEl) {
              delete $pageEl[0].zmpPage.navbarEl.zmpPage;
            }

            $pageEl[0].zmpPage = null;
          }
        }
      };
      ...
      _proto.saveHistory = function saveHistory() {
        ...
        if (router.params.browserHistory && router.params.browserHistoryStoreHistory && window.localStorage) {
          window.localStorage["zmprouter-" + router.view.id + "-history"] = JSON.stringify(router.history);
        }
      };
      ...
      _proto.restoreHistory = function restoreHistory() {
        ...
        if (router.params.browserHistory && router.params.browserHistoryStoreHistory && window.localStorage && window.localStorage["zmprouter-" + router.view.id + "-history"]) {
          router.history = JSON.parse(window.localStorage["zmprouter-" + router.view.id + "-history"]);
          router.view.history = router.history;
        }
      };
      ...
      _proto.getInitialUrl = function getInitialUrl() {
        ...
        var browserHistoryRoot = router.params.browserHistoryRoot;
        var documentPathName = location.pathname;
        var initialPath = documentPathName.split(browserHistoryRoot)[1];
        ...
        if (!browserHistory || !browserHistoryOnLoad) {
          ...
          if (view.params.tab && !view.params.tabActive) {
            initialUrl = view.params.url;
          }
          ...
          } else if (router.params.url === initialUrl || router.params.url === initialPath) {
    ...
    function resizableView(view) {
      ...
      function handleTouchMove(e) {
        ...
        $htmlEl[0].style.setProperty('--zmp-page-master-width', newWidth + "px");
      ...
      function handleTouchEnd() {
        ...
        isTouched = false;
        isMoved = false;
        $htmlEl[0].style.setProperty('--zmp-page-master-width', view.resizableWidth + "px");
    ...
    var View$1 = /*#__PURE__*/function (_ZMPClass) {
      _inheritsLoose(View, _ZMPClass);
      ...
      function View(app, el, viewParams) {
        ...
        _this = _ZMPClass.call(this, viewParams, [app]) || this;
        ...
        if (!ssr) {
          ...
          if (!$el.length) {
            var message = "ZMP: can't create a View instance because ";
            message += typeof el === 'string' ? "the selector \"" + el + "\" didn't match any element" : 'el must be an HTMLElement or zmpDOM object';
      ...
      _proto.destroy = function destroy() {
        ...
        view.$el[0].zmpView = null;
        delete view.$el[0].zmpView;
      ...
      _proto.mount = function mount(viewEl) {
        ...
        if (typeof el === 'string') selector = el;else {
          // Supposed to be HTMLElement or zmpDOM
      ...
      _proto.init = function init(viewEl) {
        ...
        if (view.params.router) {
          ...
          if (view.params.initRouterOnTabShow && view.$el.hasClass('tab') && !view.$el.hasClass('tab-active')) {
            view.$el.once('tab:show', function () {
              view.router.init();
            });
          } else {
            view.router.init();
      ...
      function handleClicks(e) {
        ...
        if (validUrl || $clickedLinkEl.hasClass('back')) {
          ...
          if (clickedLinkData.view && clickedLinkData.view === 'current') {
            ...
            view = $(clickedLinkData.view)[0].zmpView;
          } else {
            view = $clickedEl.parents('.view')[0] && $clickedEl.parents('.view')[0].zmpView;

            if (!$clickedLinkEl.hasClass('back') && view && view.params.linksView) {
              if (typeof view.params.linksView === 'string') view = $(view.params.linksView)[0].zmpView;else if (view.params.linksView instanceof View$1) view = view.params.linksView;
            }
          }
    ...
    var createCustomComponent = function createCustomComponent(_ref) {
      ...
      zmp.component.create(component, propsFromAttrs(data.attrs || {}, data.props || {}), {
        el: vnode.elm,
    ...
    function getHooks(treeNode, data, zmp, initial, isRoot) {
      var hooks = {};
      var insert = [];
      var destroy = [];
      var update = [];
      ...
      if (!isCustom) {
        ...
        classNames.split(' ').forEach(function (className) {
          if (!initial) {
            insert.push.apply(insert, zmp.getVnodeHooks('insert', className));
          }

          destroy.push.apply(destroy, zmp.getVnodeHooks('destroy', className));
          update.push.apply(update, zmp.getVnodeHooks('update', className));
          postpatch.push.apply(postpatch, zmp.getVnodeHooks('postpatch', className));
        });
      }
    ...
    var getData = function getData(treeNode, component, zmp, initial, isRoot) {
      var data = {
        component: component,
        treeNode: treeNode
      };
      ...
      var hooks = getHooks(treeNode, data, zmp, initial, isRoot);
    ...
    var getChildren = function getChildren(treeNode, component, zmp, initial) {
      ...
      for (var i = 0; i < nodes.length; i += 1) {
        ...
        var child = treeNodeToVNode(childNode, component, zmp, initial, false);
    ...
    var getSlots = function getSlots(treeNode, component, zmp, initial) {
      ...
      if (slotNodes.length === 0) {
        return getChildren(treeNode, component, zmp, initial);
      }

      return slotNodes.map(function (subTreeNode) {
        return treeNodeToVNode(subTreeNode, component, zmp, initial);
      });
    };
    ...
    var treeNodeToVNode = function treeNodeToVNode(treeNode, component, zmp, initial, isRoot) {
      if (!isTreeNode(treeNode)) {
        return String(treeNode);
      }

      if (treeNode.type === 'slot') {
        return getSlots(treeNode, component, zmp, initial);
      }

      var data = getData(treeNode, component, zmp, initial, isRoot);
      var children = isCustomComponent(treeNode.type) ? [] : getChildren(treeNode, component, zmp, initial);
    ...
    function vdom(tree, component, initial) {
      ...
      return treeNodeToVNode(tree, component, component.zmp, initial, true);
    }
    ...
    function parseComponent(componentString) {
      ...
      var document = getDocument();
      var componentId = id();
      var callbackCreateName = "zmp_component_create_callback_" + componentId; // Template
      ...
      store.dispatch = function (actionName, data) {
        return new Promise(function (resolve, reject) {
          if (!actions[actionName]) {
            reject();
            throw new Error("ZMP: Store action \"" + actionName + "\" is not found");
          }
    ...
    function getCurrentView(app) {
      ...
      if ($popoverView.length > 0 && $popoverView[0].zmpView) return $popoverView[0].zmpView;
      if ($popupView.length > 0 && $popupView[0].zmpView) return $popupView[0].zmpView;
      if ($panelView.length > 0 && $panelView[0].zmpView) return $panelView[0].zmpView;

      if ($viewEl.length > 0) {
        if ($viewEl.length === 1 && $viewEl[0].zmpView) return $viewEl[0].zmpView;
    ...
    var View = {
      ...
      params: {
        view: {
          ...
          browserHistoryRoot: "/zapps/" + window.APP_ID ,
        ...
        extend(app, {
          views: extend([], {
            ...
            get: function get(viewEl) {
              var $viewEl = $(viewEl);
              if ($viewEl.length && $viewEl[0].zmpView) return $viewEl[0].zmpView;
              return undefined;
            }
          })
        });
    ...
    var Navbar = {
      size: function size(el) {
        ...
        if ($viewEl.length > 0 && $viewEl[0].zmpView) {
          router = $viewEl[0].zmpView.router;
        ...
        if (dynamicNavbar && app.theme === 'ios') {
          if (title.hasClass('sliding') || title.length > 0 && sliding) {
            ...
            title[0].zmpNavbarLeftOffset = titleLeftOffset;
            title[0].zmpNavbarRightOffset = titleRightOffset;
          }

          if (!noLeft && (left.hasClass('sliding') || sliding)) {
            if (app.rtl) {
              left[0].zmpNavbarLeftOffset = -(navbarInnerWidth - left[0].offsetWidth) / 2 * inverter;
              left[0].zmpNavbarRightOffset = leftWidth * inverter;
            } else {
              left[0].zmpNavbarLeftOffset = -leftWidth;
              left[0].zmpNavbarRightOffset = (navbarInnerWidth - left[0].offsetWidth) / 2;

              if (router && router.params.iosAnimateNavbarBackIcon && left.find('.back .icon').length > 0) {
                if (left.find('.back .icon ~ span').length) {
                  var leftOffset = left[0].zmpNavbarLeftOffset;
                  var rightOffset = left[0].zmpNavbarRightOffset;
                  left[0].zmpNavbarLeftOffset = 0;
                  left[0].zmpNavbarRightOffset = 0;
                  left.find('.back .icon ~ span')[0].zmpNavbarLeftOffset = leftOffset;
                  left.find('.back .icon ~ span')[0].zmpNavbarRightOffset = rightOffset - left.find('.back .icon')[0].offsetWidth;
                }
              }
            }
          }
          ...
          if (!noRight && (right.hasClass('sliding') || sliding)) {
            if (app.rtl) {
              right[0].zmpNavbarLeftOffset = -rightWidth * inverter;
              right[0].zmpNavbarRightOffset = (navbarInnerWidth - right[0].offsetWidth) / 2 * inverter;
            } else {
              right[0].zmpNavbarLeftOffset = -(navbarInnerWidth - right[0].offsetWidth) / 2;
              right[0].zmpNavbarRightOffset = rightWidth;
            }
          }

          if (subnavbar.length && (subnavbar.hasClass('sliding') || sliding)) {
            subnavbar[0].zmpNavbarLeftOffset = app.rtl ? subnavbar[0].offsetWidth : -subnavbar[0].offsetWidth;
            subnavbar[0].zmpNavbarRightOffset = -subnavbar[0].zmpNavbarLeftOffset;
          }
        } // Center title
      ...
      getElByPage: function getElByPage(page) {
        ...
        if (page.$navbarEl || page.$el) {
          ...
          $pageEl = $(page);
          if ($pageEl.length > 0) pageData = $pageEl[0].zmpPage;
        }
      ...
      getPageByEl: function getPageByEl(navbarEl) {
        ...
        $navbarEl.parents('.view').find('.page').each(function (el) {
          if (el && el.zmpPage && el.zmpPage.navbarEl && $navbarEl[0] === el.zmpPage.navbarEl) {
            pageEl = el;
          }
        });
        return pageEl;
      ...
      initNavbarOnScroll: function initNavbarOnScroll(pageEl, navbarEl, needHide, needCollapse, needTransparent) {
        ...
        if (needCollapse || needHide && isLarge) {
          navbarTitleLargeHeight = $navbarEl.css('--zmp-navbar-large-title-height');
        ...
        $pageEl[0].zmpDetachNavbarScrollHandlers = function zmpDetachNavbarScrollHandlers() {
          delete $pageEl[0].zmpDetachNavbarScrollHandlers;
    ...
    var Navbar$1 = {
      ...
      on: {
        ...
        pageBeforeRemove: function pageBeforeRemove(page) {
          if (page.$el[0].zmpDetachNavbarScrollHandlers) {
            page.$el[0].zmpDetachNavbarScrollHandlers();
          }
        },
        pageBeforeIn: function pageBeforeIn(page) {
          ...
          var $navbarsEl;
          var view = page.$el.parents('.view')[0].zmpView;
    ...
    var Toolbar = {
      ...
      initToolbarOnScroll: function initToolbarOnScroll(pageEl) {
        ...
        $pageEl.on('scroll', '.page-content', handleScroll, true);
        $pageEl[0].zmpScrollToolbarHandler = handleScroll;
      }
    };
    var Toolbar$1 = {
      name: 'toolbar',
      ...
      on: {
        pageBeforeRemove: function pageBeforeRemove(page) {
          if (page.$el[0].zmpScrollToolbarHandler) {
            page.$el.off('scroll', '.page-content', page.$el[0].zmpScrollToolbarHandler, true);
          }
        },
        pageBeforeIn: function pageBeforeIn(page) {
          var app = this;
    ...
    var TouchRipple$1 = /*#__PURE__*/function () {
      function TouchRipple(app, $el, x, y) {
        ...
        ripple.$rippleWaveEl = $("<div class=\"ripple-wave\" style=\"width: " + diameter + "px; height: " + diameter + "px; margin-top:-" + diameter / 2 + "px; margin-left:-" + diameter / 2 + "px; left:" + center.x + "px; top:" + center.y + "px; --zmp-ripple-transform: " + ripple.rippleTransform + "\"></div>");
    ...
    var Modal$1 = /*#__PURE__*/function (_ZMPClass) {
      _inheritsLoose(Modal, _ZMPClass);

      function Modal(app, params) {
        var _this;

        _this = _ZMPClass.call(this, params, [app]) || this;
        ...
        if ($backdropEl) {
          ...
          if (modal.type === 'popup') {
            modal.$el.prevAll('.popup.modal-in').add(modal.$el.nextAll('.popup.modal-in')).each(function (popupEl) {
              var popupInstance = popupEl.zmpModal;
      ...
      _proto.destroy = function destroy() {
        ...
        if (modal.$el) {
          ...
          if (modal.$el.length && modal.$el[0].zmpModal) {
            delete modal.$el[0].zmpModal;
          }
        }
    ...
    var CustomModal = /*#__PURE__*/function (_Modal) {
      ...
      function CustomModal(app, params) {
        ...
        if ($el && $el.length > 0 && $el[0].zmpModal) {
          return $el[0].zmpModal || _assertThisInitialized(_this);
        }
    ...
    if (typeof window !== 'undefined') {
      // zmpDOM
      if (!window.zmpDOM) window.zmpDOM = $;
    } // UMD_ONLY_END


    Router.use([RouterComponentLoaderModule]);
    ZMP.use([DeviceModule, SupportModule, UtilsModule, ResizeModule, RequestModule, TouchModule, ClicksModule, RouterModule, HistoryModule, ComponentModule, ServiceWorkerModule, StoreModule, Statusbar$1, View, Navbar$1, Toolbar$1, Subnavbar, TouchRipple, Modal]);
