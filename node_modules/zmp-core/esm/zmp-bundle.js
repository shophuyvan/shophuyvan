...
import ZMP from './components/app/app-class';
...
ZMP.use([DeviceModule, SupportModule, UtilsModule, ResizeModule, RequestModule, TouchModule, ClicksModule, RouterModule, HistoryModule, ComponentModule, ServiceWorkerModule, StoreModule, Statusbar, View, Navbar, Toolbar, Subnavbar, TouchRipple, Modal, Appbar, Dialog, Popup, LoginScreen, Popover, Actions, Sheet, Toast, Preloader, Progressbar, List, Sortable, Swipeout, Accordion, ContactsList, VirtualList, ListIndex, Timeline, Tabs, Panel, Card, Chip, Form, Input, Checkbox, Radio, Toggle, Range, Stepper, SmartSelect, Grid, Calendar, Picker, InfiniteScroll, PullToRefresh, Lazy, Fab, Searchbar, Notification, Autocomplete, Tooltip, Gauge, Skeleton, Menu, ColorPicker, Treeview, TextEditor, Elevation, Typography, Button, Badge, Swiper]);
export { Component, $jsx, $ as zmpDOM, request, utils, getDevice, getSupport, createStore };
export default ZMP;
