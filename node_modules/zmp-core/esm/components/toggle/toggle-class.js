...
var Toggle = /*#__PURE__*/function (_ZMPClass) {
  _inheritsLoose(Toggle, _ZMPClass);
  ...
  function Toggle(app, params) {
    ...
    if ($el[0].zmpToggle) return $el[0].zmpToggle || _assertThisInitialized(_this);
