...
var Popover = /*#__PURE__*/function (_Modal) {
  ...
  _proto.resize = function resize() {
    ...
    var targetOffsetTop;
    var safeAreaTop = parseInt($('html').css('--zmp-safe-area-top'), 10);
    var safeAreaLeft = parseInt($('html').css('--zmp-safe-area-left'), 10);
    var safeAreaRight = parseInt($('html').css('--zmp-safe-area-right'), 10);
