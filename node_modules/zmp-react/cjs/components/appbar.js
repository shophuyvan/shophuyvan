...
var Appbar = /*#__PURE__*/(0, _react.forwardRef)(function (props, ref) {
  ...
  if (inner) {
    innerEl = /*#__PURE__*/_react.default.createElement("div", {
      className: (0, _utils.classNames)('appbar-inner', innerClass, innerClassName)
    }, children);
  }

  var classes = (0, _utils.classNames)(className, 'appbar', {
    'no-shadow': noShadow,
