...
var ComponentName = /*#__PURE__*/(0, _react.forwardRef)(function (props, ref) {
  ...
  var onClick = function onClick(e) {
    if (elRef.current && close && _zmp.zmp) {
      _zmp.zmp.actions.close(_zmp.zmp.$(elRef.current).parents('.actions-modal'));
    }
