...
// ../../../.wrangler/tmp/bundle-joCM0x/checked-fetch.js
...
// facebook-feed.csv.js
async function onRequest(context) {
  const PRODUCTS_API = "https://shophuyvan1.pages.dev/api/products.json";
  const escapeCsv = /* @__PURE__ */ __name((val = "") => {
    const s = String(val ?? "");
    const needsQuote = /[",\n]/.test(s);
    const out = s.replace(/"/g, '""');
    return needsQuote ? `"${out}"` : out;
  }, "escapeCsv");
  const priceVND = /* @__PURE__ */ __name((n) => `${Math.round(Number(n || 0))} VND`, "priceVND");
  let products = [];
  try {
    ...
    products = [{
      id: "SP-001",
      title: "\xC1o thun c\u1ED5 tr\xF2n",
      description: "\xC1o cotton 100% co gi\xE3n, form regular.",
      price: 129e3,
      salePrice: 99e3,
      inStock: true,
...
// ../../../.wrangler/tmp/pages-ruUIkm/functionsRoutes-0.6206872244835433.mjs
var routes = [
  {
...
// ../../../.wrangler/tmp/bundle-joCM0x/middleware-insertion-facade.js
...
// ../../../.wrangler/tmp/bundle-joCM0x/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.08858059636802618.mjs.map
